...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles["sekai-title-header-".concat(size)], rest.className)
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles['sekai-buttons-area'], rest.className)
...
export { Dialog, DialogButtons, DialogTitleHeader };
