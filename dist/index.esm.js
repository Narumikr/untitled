...
var _excluded$1 = ["sekaiKeys", "themeMode", "text", "duration"];
...
var DoReMeetEffect = function DoReMeetEffect(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    ...
    className: clsx(styles$3["sekai-doremeet-effect-".concat(modeTheme)], rest.className),
...
export { Accordion, BasicButton, COLORS_SEKAI_KEYS, Card, CardContent, CardTitle, DARK_MODE, Dialog, DialogButtons, DialogTitleHeader, DoReMeetEffect, Drawer, HamburgerButton, LIGHT_MODE, List, ListContext, ListItemButton, ListItemText, NamePlate, OutlineText, PrskLinkCard, StickyNote, StrongButton, TextLink, XoMikuDialog, XxMikuDialog, YourSekaiContext, YourSekaiProvider, colorsSekai, convertHexToRgb, convertHexToRgbMixWithWhite, convertHexToRgba, createSekai, fireOnEnterKey, fireOnEscapeKey, useCreateSekai, useThemeMode };
