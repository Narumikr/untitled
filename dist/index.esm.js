...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$3(_objectSpread$3({}, pre), {}, {
        palette: _objectSpread$3(_objectSpread$3({}, pre.palette), {}, {
          sekai: sekai
        })
      });
    });
...
var BasicButton = function BasicButton(_ref) {
  ...
  var optionStyle = _objectSpread$2({
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    className: [styles$7["sekai-basic-button-".concat(modeTheme)], globalStyles["sekai-color-".concat(modeTheme)], className].join(' '),
    style: optionStyle,
    disabled: disabled
...
var StrongButton = function StrongButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    className: [styles$6["sekai-strong-button-".concat(modeTheme)], className].join(' '),
    style: optionStyle,
    disabled: disabled
  }, buttonProps), children);
};
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    role: "dialog",
    className: [globalStyles["sekai-color-".concat(modeTheme)], globalStyles['sekai-absolute-center'], styles$5["sekai-container-".concat(size)]].join(' '),
    style: optionStyle,
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: [styles$5["sekai-title-header-".concat(size)], className].join(' ')
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: [styles$5['sekai-buttons-area'], className].join(' ')
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: [globalStyles["sekai-color-".concat(modeTheme)], styles$5["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$5["sekai-".concat(modeTheme)], el.buttonStyle || ''].join(' '),
      style: optionStyle
    }, el.text);
  }));
};
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    role: "dialog",
    className: [globalStyles['sekai-absolute-center'], styles$4["sekai-container-".concat(size)]].join(' '),
    "aria-label": title || 'Dialog'
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    role: "dialog",
    className: [globalStyles['sekai-absolute-center'], styles$3["sekai-container-".concat(size)], styles$3["sekai-".concat(modeTheme)]].join(' '),
    "aria-label": title || 'Dialog'
...
var TextLink = function TextLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", {
    className: [styles$2["sekai-text-link-".concat(modeTheme)], disabled && styles$2['sekai-disabled'], className].join(' '),
    style: optionStyle,
    href: href,
...
export { BasicButton, COLORS_SEKAI_KEYS, DARK_MODE, Dialog, DialogButtons, DialogTitleHeader, LIGHT_MODE, NamePlate, OutlineText, StrongButton, TextLink, XoMikuDialog, XxMikuDialog, YourSekaiContext, YourSekaiProvider, colorsSekai, convertHexToRgb, convertHexToRgba, createSekai, fireOnEnterKey, fireOnEscapeKey, useCreateSekai, useThemeMode };
