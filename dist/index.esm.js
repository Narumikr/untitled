...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$p(_objectSpread$p({}, pre), {}, {
        palette: _objectSpread$p(_objectSpread$p({}, pre.palette), {}, {
          sekai: sekai
        })
      });
    });
...
var Accordion = function Accordion(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$o['sekai-accordion-container'], rest.className),
    style: _objectSpread$o(_objectSpread$o({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$o['sekai-accordion-summary'], globalStyles["sekai-color-".concat(modeTheme)], summaryStyles),
    onClick: handleOpenClose,
    id: "accordion-summary",
    "aria-expanded": openAccordion,
    "aria-controls": "details-contents"
  }, /*#__PURE__*/React.createElement("p", {
    className: styles$o['sekai-accordion-summary-text']
  }, summary), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$o["sekai-accordion-summary-icon"], openAccordion ? styles$o['sekai-icon-open'] : styles$o['sekai-icon-close']),
    sekai: sekai,
    themeMode: themeMode,
    vector: "up"
  })), /*#__PURE__*/React.createElement("hr", {
    className: styles$o['sekai-web-horizon']
...
var AccordionDetailsContents = function AccordionDetailsContents(_ref2) {
  ...
  var animationDetailsStyles = _objectSpread$o(_objectSpread$o({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$o['sekai-accordion-details'],
...
var BasicButton = function BasicButton(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    isLight = _useOptionalSekai.isLight;
  var sekaiColorHover = convertHexToRgba(sekaiColor, isLight ? 0.1 : 0.3);
  var optionStyle = _objectSpread$n({
    '--sekai-color': sekaiColor,
    '--sekai-color-hover': sekaiColorHover
  }, withText && {
    color: sekaiColor
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$n["sekai-basic-button-".concat(modeTheme)], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var HamburgerButton = function HamburgerButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$m["sekai-hamburger-button-".concat(modeTheme)], rest.className),
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      className: clsx(styles$m['sekai-hamburger-line'], open && styles$m['sekai-open'])
    });
  }));
};
...
var ScrollTopButton = function ScrollTopButton(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("button", _extends({}, rest, {
    className: clsx(styles$l["sekai-scroll-top-button-".concat(pos)], rest.className),
    style: _objectSpread$l(_objectSpread$l({}, optionStyle), rest.style),
    onClick: handleScroll
  }), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$l['sekai-scroll-top-icon']),
    sekai: sekai,
    themeMode: themeMode
  })), document.body);
};
...
var StrongButton = function StrongButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$k["sekai-strong-button-".concat(modeTheme)], rest.className),
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$i['sekai-card'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var CardContent = function CardContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$i['sekai-card-content'], globalStyles["sekai-color-".concat(modeTheme)], rest.className)
  }), children);
};
var CardTitle = function CardTitle(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("h3", _extends({}, rest, {
    className: clsx(styles$i['sekai-card-title'], globalStyles["sekai-color-".concat(modeTheme)], underline && styles$i['sekai-underline'], rest.className),
    style: _objectSpread$i(_objectSpread$i({}, optionStyle), rest.style)
  }), title);
};
...
var NamePlate = function NamePlate(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$h["sekai-name-plate-".concat(modeTheme)], rest.className),
    style: _objectSpread$h(_objectSpread$h({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("span", {
    className: styles$h['sekai-name-plate-color']
...
var OutlineText = function OutlineText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, rest, {
    className: clsx(styles$g["sekai-outline-text-".concat(modeTheme)], rest.className),
...
var PrskLinkCard = function PrskLinkCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, _extends({}, rest, {
    ...
    className: clsx(styles$f['sekai-prsk-link-card-button'], globalStyles["sekai-color-".concat(modeTheme)]),
    style: (cardSizeStyle),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(NamePlate, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-title"),
    className: clsx(styles$f['sekai-prsk-link-card-title'], styles$f["sekai-title-effect-".concat(modeTheme)]),
    sekai: sekai,
    themeMode: themeMode,
    text: title
  }), /*#__PURE__*/React.createElement(OutlineText, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-subtext"),
    className: styles$f['sekai-prsk-link-card-subtext'],
    sekai: sekai,
    themeMode: themeMode,
    text: subText
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$f['sekai-prsk-link-card-icon']
...
var css_248z$e = ".CommonComponents-module_sekai-dialog-visible__hheii {\n  display: block;\n}\n\n.CommonComponents-module_sekai-dialog-hidden__eu6kA {\n  display: none;\n}";
var styles$e = {"sekai-dialog-visible":"CommonComponents-module_sekai-dialog-visible__hheii","sekai-dialog-hidden":"CommonComponents-module_sekai-dialog-hidden__eu6kA"};
...
var DialogOverlay = function DialogOverlay(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    modeTheme = _useOptionalSekai.modeTheme;
  var optionStyle = _objectSpread$f({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/React.createElement("div", {
    className: styles$e[displayDialog]
  }, /*#__PURE__*/React.createElement("div", {
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], globalStyles['sekai-absolute-center'], styles$d["sekai-container-".concat(size)], rest.className),
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$d["sekai-title-header-".concat(size)], rest.className)
  }), /*#__PURE__*/React.createElement("h2", null, title), showCloseIcon ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: styles$d['sekai-close-icon'],
    onClick: onClose
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$d['sekai-buttons-area'], rest.className)
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$d["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$d["sekai-".concat(modeTheme)], el.buttonStyle || ''),
      style: optionStyle
    }, el.text);
  }));
};
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  var xoButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$d(_objectSpread$d({}, button), {}, {
        buttonStyle: [styles$c["sekai-xomiku-".concat(type, "-button")]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$c["sekai-container-".concat(size)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$c["sekai-xomiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$c["sekai-xomiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$c["sekai-xomiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$c["sekai-xomiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$c["sekai-xomiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$c['sekai-xomiku-button']
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  var xxButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      var type = button.type ? button.type : 'normal';
      return _objectSpread$c(_objectSpread$c({}, button), {}, {
        buttonStyle: [styles$b["sekai-xxmiku-".concat(type, "-button")], styles$b["sekai-".concat(modeTheme)]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$b["sekai-container-".concat(size)], styles$b["sekai-".concat(modeTheme)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$b["sekai-xxmiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$b["sekai-xxmiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$b["sekai-xxmiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$b["sekai-xxmiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$b["sekai-xxmiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    id: "xo-miku-dialog-buttons",
    className: styles$b['sekai-xxmiku-button']
  }, buttonsProps))))), portalContainer);
};
...
var Drawer = function Drawer(_ref) {
  ...
  var posAbsoluteStyle = _objectSpread$b({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    className: clsx(globalStyles["sekai-overlay-".concat(modeTheme)], styles$a['sekai-drawer'], styles$a[displayDrawer]),
    style: posAbsoluteStyle,
    "aria-hidden": "true",
    onClick: onClose
  }, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$a["sekai-drawer-contents-".concat(pos)], styles$a[displayDrawer], rest.className),
...
var DropdownContent = function DropdownContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: wrapDropdownRef,
    className: clsx(styles$9["sekai-dropdown-".concat(modeTheme)], rest.className),
    ...
    style: _objectSpread$a(_objectSpread$a({}, optionStyle), dropdownPosStyle),
    sekai: sekai,
    themeMode: themeMode,
    options: options,
    onSelect: onSelect
...
var DropdownTriggerButton = /*#__PURE__*/forwardRef(function (_ref4, ref) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ref: ref,
    type: "button",
    className: styles$9["sekai-dropdown-trigger-".concat(modeTheme)],
    onClick: handleClick,
    style: optionStyle
  }, /*#__PURE__*/React.createElement("span", {
    className: clsx(_defineProperty({}, styles$9['sekai-placeholder'], isDispPlaceholder))
  }, displayText), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$9['sekai-dropdown-icon'], _defineProperty(_defineProperty({}, styles$9['sekai-dropdown-icon-open'], openOptions), styles$9["sekai-dropdown-icon-close"], !openOptions)),
    sekai: sekai,
    themeMode: themeMode,
    vector: "down"
  }));
...
var DropdownOptions = function DropdownOptions(_ref6) {
  ...
  return isRendered ? /*#__PURE__*/React.createElement("ul", {
    className: clsx(styles$9['sekai-dropdown-options-list'], _defineProperty(_defineProperty({}, styles$9['sekai-dropdown-options-open'], isVisible), styles$9['sekai-dropdown-options-close'], !isVisible), globalStyles["sekai-color-".concat(modeTheme)]),
    style: _objectSpread$a(_objectSpread$a({}, optionStyle), style)
  }, options.map(function (option) {
    return /*#__PURE__*/React.createElement("li", {
      key: option.value,
      className: clsx(styles$9['sekai-dropdown-option-item'])
    }, /*#__PURE__*/React.createElement("button", {
...
var DoReMeetEffect = function DoReMeetEffect(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    ...
    className: clsx(styles$8["sekai-doremeet-effect-".concat(modeTheme)], rest.className),
...
var styles$7 = {"into-the-sekai":"IntoTheSekai-module_into-the-sekai__GYjaM"};
styleInject(css_248z$7);

var _excluded$7 = ["execEvent", "containerComponent"];
...
var IntoTheSekai = function IntoTheSekai(_ref) {
  ...
  var optionStyle = _objectSpread$8({}, containerComponent && {
    position: 'absolute'
  });
  useEffect(function () {
  ...
  useEffect(function () {
    ...
    var _render = function render() {
      ...
      sekaiPieceRef.current = sekaiPieceRef.current.map(function (tri) {
        ...
        return _objectSpread$8(_objectSpread$8({}, tri), {}, {
          points: newPoints,
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("canvas", _extends({}, rest, {
    className: clsx(styles$7['into-the-sekai'], rest.className),
...
var TextLink = function TextLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", _extends({}, rest, {
    className: clsx(styles$6["sekai-text-link-".concat(modeTheme)], disabled && styles$6['sekai-disabled'], rest.className),
...
var List = function List(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ListContext.Provider, {
    ...
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$5['sekai-list'], rest.className),
...
var ListItemButton = function ListItemButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    id: id,
    className: clsx(styles$5['sekai-list-item-button'], className),
    style: _objectSpread$5(_objectSpread$5({}, optionStyle), style)
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    ref: listItemButtonRef,
    className: styles$5["sekai-list-button-".concat(modeTheme)],
    disabled: disabled,
...
var getImgComponent$1 = function getImgComponent(icon) {
  ...
  if (typeof icon === 'string') {
    return /*#__PURE__*/React.createElement("img", {
      className: styles$5['sekai-list-icon'],
      src: icon,
      alt: ""
    });
  } else {
...
var createRippleEffect = function createRippleEffect(x, y, size) {
  ...
  ripple.className = styles$5["".concat(rippleEffectClassName)];
  return ripple;
};
...
var _excluded$4 = ["sekai", "themeMode", "children", "as", "icon"];
...
var ListItemText = function ListItemText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", _extends({}, rest, {
    className: clsx(styles$5['sekai-list-item-text'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var css_248z$4 = ".StickyNote-module_sekai-sticky-note__rheDG,\n.StickyNote-module_sekai-sticky-note__rheDG > button {\n  padding-left: 0;\n  padding-right: 0;\n}\n\n.StickyNote-module_sekai-sticky-note-parts__7ixUr {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  height: 100%;\n  background-color: var(--sekai-color-bg);\n  padding-right: 8px;\n}\n.StickyNote-module_sekai-sticky-note-parts__7ixUr .StickyNote-module_sekai-sticky-note-design__Aae2S {\n  width: 15px;\n  height: 100%;\n  background-color: var(--sekai-color);\n  margin-right: 8px;\n}";
var styles$4 = {"sekai-sticky-note":"StickyNote-module_sekai-sticky-note__rheDG","sekai-sticky-note-parts":"StickyNote-module_sekai-sticky-note-parts__7ixUr","sekai-sticky-note-design":"StickyNote-module_sekai-sticky-note-design__Aae2S"};
styleInject(css_248z$4);

var _excluded$3 = ["sekai", "children", "as"];
var StickyNote = function StickyNote(_ref) {
  ...
  return 'button' === as ? /*#__PURE__*/React.createElement(ListItemButton, _extends({}, rest, {
    className: clsx(styles$4['sekai-sticky-note'], rest.className),
    sekai: sekai,
    themeMode: LIGHT_MODE
...
var Loading = function Loading(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    role: "status",
    "aria-live": "polite",
    className: clsx(styles$3['sekai-loading'], className),
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: clsx(styles$3['sekai-loading-circle'], styles$3["sekai-circle-animation-".concat(index)])
    });
  }));
};
...
var Pagination = function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$2["sekai-pagination-".concat(size)], rest.className),
    ...
    if (item === PaginationConstants.Ellipsis) {
      return /*#__PURE__*/React.createElement("span", {
        key: index,
        className: styles$2['sekai-pagination-ellipsis']
      }, '...');
    }
    return /*#__PURE__*/React.createElement("button", {
      key: index,
      className: clsx(styles$2["sekai-pagination-button-".concat(size)], styles$2["sekai-color-".concat(modeTheme)], _defineProperty({}, styles$2["sekai-pagination-selected"], item === currentPage)),
      onClick: function onClick() {
...
var CtrlButton = function CtrlButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$2["sekai-pagination-button-".concat(size)]),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(ArrowSvg, _extends({}, rest, {
    vector: vector,
    className: styles$2['sekai-pagination-arrow']
  })));
};
...
var BodyText = function BodyText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("p", _extends({}, rest, {
    className: clsx(styles$1["sekai-body-text-".concat(modeTheme)], isPortrait ? globalStyles['text-sm'] : globalStyles['text-base'], rest.className)
  }), children);
};
var SekaiBodyText = function SekaiBodyText(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(BodyText, _extends({}, rest, {
    style: _objectSpread$1(_objectSpread$1({}, colorStyle), rest.style)
  }), children);
};
var DetailText = function DetailText(_ref3) {
  ...
  var _useOptionalSekai3 = useOptionalSekai({
    ...
    modeTheme = _useOptionalSekai3.modeTheme;
  return /*#__PURE__*/React.createElement("p", _extends({}, rest, {
    className: clsx(styles$1["sekai-detail-text-".concat(modeTheme)], globalStyles['text-xs'], rest.className)
  }), children);
};
...
var AnnotationText = function AnnotationText(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(DetailText, _extends({}, rest, {
    className: clsx(styles$1["sekai-annotation-text-".concat(modeTheme)], rest.className)
  }), children);
};
...
export { Accordion, AnnotationText, BasicButton, BodyText, COLORS_SEKAI_KEYS, Card, CardContent, CardTitle, DARK_MODE, DetailText, Dialog, DialogButtons, DialogTitleHeader, DoReMeetEffect, Drawer, Dropdown, DropdownContent, HamburgerButton, IntoTheSekai, LIGHT_MODE, List, ListContext, ListItemButton, ListItemText, Loading, NamePlate, ORIENTATION, OutlineText, Pagination, PrskLinkCard, ScrollTopButton, SekaiAnnotationText, SekaiBodyText, SekaiDetailText, StickyNote, StrongButton, StylishButton, TextField, TextLink, XoMikuDialog, XxMikuDialog, YourSekaiContext, YourSekaiProvider, colorsSekai, convertHexToRgb, convertHexToRgbMixWithWhite, convertHexToRgba, createSekai, fireOnEnterKey, fireOnEscapeKey, shuffleArray, useCreateSekai, useInnerSize, useOrientation, useTabletSize, useThemeMode };
