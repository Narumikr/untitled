...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$f(_objectSpread$f({}, pre), {}, {
        palette: _objectSpread$f(_objectSpread$f({}, pre.palette), {}, {
          sekai: sekai
        })
      });
    });
...
var Accordion = function Accordion(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: id,
    className: clsx(styles$e['sekai-accordion-container'], className),
    style: _objectSpread$e(_objectSpread$e({}, optionStyle), style)
  }, /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$e['sekai-accordion-summary'], globalStyles["sekai-color-".concat(modeTheme)], summaryStyles),
    onClick: handleOpenClose,
    id: "accordion-summary",
    "aria-expanded": openAccordion,
    "aria-controls": "details-contents"
  }, /*#__PURE__*/React.createElement("p", {
    className: styles$e['sekai-accordion-summary-text']
  }, summary), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$e["sekai-accordion-summary-icon"], openAccordion ? styles$e['sekai-icon-open'] : styles$e['sekai-icon-close']),
    sekai: sekai,
    themeMode: themeMode,
    vector: "up"
  })), /*#__PURE__*/React.createElement("hr", {
    className: styles$e['sekai-web-horizon']
...
var AccordionDetailsContents = function AccordionDetailsContents(_ref2) {
  ...
  var animationDetailsStyles = _objectSpread$e(_objectSpread$e({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$e['sekai-accordion-details'],
...
var DetailText = function DetailText(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("p", {
    className: styles$e['sekai-detail-text']
  }, text);
};
...
var BasicButton = function BasicButton(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    isLight = _useOptionalSekai.isLight;
  var sekaiColorHover = convertHexToRgba(sekaiColor, isLight ? 0.1 : 0.3);
  var optionStyle = _objectSpread$d({
    '--sekai-color': sekaiColor,
    '--sekai-color-hover': sekaiColorHover
  }, withText && {
    color: sekaiColor
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    id: id,
    type: "button",
    className: clsx(styles$d["sekai-basic-button-".concat(modeTheme)], globalStyles["sekai-color-".concat(modeTheme)], className),
...
var HamburgerButton = function HamburgerButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$c["sekai-hamburger-button-".concat(modeTheme)], rest.className),
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      className: clsx(styles$c['sekai-hamburger-line'], open && styles$c['sekai-open'])
    });
  }));
};
...
var StrongButton = function StrongButton(_ref) {
  var id = _ref.id,
    ...
    _ref$disabled = _ref.disabled,
    disabled = _ref$disabled === void 0 ? false : _ref$disabled,
    buttonProps = _objectWithoutProperties(_ref, _excluded$2);
  var _useOptionalSekai = useOptionalSekai({
      sekai: sekai,
      mode: themeMode
    }),
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: id,
    className: clsx(styles$a['sekai-card'], globalStyles["sekai-color-".concat(modeTheme)], className),
...
var CardContent = function CardContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: id,
    className: clsx(styles$a['sekai-card-content'], globalStyles["sekai-color-".concat(modeTheme)], className),
    style: style
  }, children);
};
var CardTitle = function CardTitle(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("h3", {
    id: id,
    className: [styles$a['sekai-card-title'], globalStyles["sekai-color-".concat(modeTheme)], underline && styles$a['sekai-underline'], className].join(' '),
    style: _objectSpread$a(_objectSpread$a({}, optionStyle), style)
  }, title);
};
...
var NamePlate = function NamePlate(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: id,
    className: clsx(styles$9["sekai-name-plate-".concat(modeTheme)], className),
    style: _objectSpread$9(_objectSpread$9({}, optionStyle), style)
  }, /*#__PURE__*/React.createElement("span", {
    className: styles$9['sekai-name-plate-color']
...
var OutlineText = function OutlineText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", {
    id: id,
    className: clsx(styles$8["sekai-outline-text-".concat(modeTheme)], className),
...
var PrskLinkCard = function PrskLinkCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, {
    ...
    className: clsx(styles$7['sekai-prsk-link-card-button'], globalStyles["sekai-color-".concat(modeTheme)]),
    style: (cardSizeStyle),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(NamePlate, {
    id: "".concat(id ? id : 'prsk-link-card', "-title"),
    className: clsx(styles$7['sekai-prsk-link-card-title'], styles$7["sekai-title-effect-".concat(modeTheme)]),
    sekai: sekai,
    themeMode: themeMode,
    text: title
  }), /*#__PURE__*/React.createElement(OutlineText, {
    id: "".concat(id ? id : 'prsk-link-card', "-subtext"),
    className: styles$7['sekai-prsk-link-card-subtext'],
    sekai: sekai,
    themeMode: themeMode,
    text: subText
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$7['sekai-prsk-link-card-icon']
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    id: id,
    role: "dialog",
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], globalStyles['sekai-absolute-center'], styles$6["sekai-container-".concat(size)], className),
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: id,
    className: clsx(styles$6["sekai-title-header-".concat(size)], className),
    style: style
  }, /*#__PURE__*/React.createElement("h2", null, title), showCloseIcon ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: styles$6['sekai-close-icon'],
    onClick: onClose
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: id,
    className: clsx(styles$6['sekai-buttons-area'], className),
    style: style
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$6["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$6["sekai-".concat(modeTheme)], el.buttonStyle || ''),
      style: optionStyle
    }, el.text);
  }));
};
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  var xoButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$6(_objectSpread$6({}, button), {}, {
        buttonStyle: [styles$5["sekai-xomiku-".concat(type, "-button")]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var buttonsProps = {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    id: id,
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$5["sekai-container-".concat(size)], className),
    style: style,
    "aria-label": title || 'Dialog'
  }, /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$5["sekai-xomiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$5["sekai-xomiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$5["sekai-xomiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$5["sekai-xomiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$5["sekai-xomiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$5['sekai-xomiku-button']
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  var xxButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$5(_objectSpread$5({}, button), {}, {
        buttonStyle: [styles$4["sekai-xxmiku-".concat(type, "-button")], styles$4["sekai-".concat(modeTheme)]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var buttonsProps = {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    id: id,
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$4["sekai-container-".concat(size)], styles$4["sekai-".concat(modeTheme)], className),
    style: style,
    "aria-label": title || 'Dialog'
  }, /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$4["sekai-xxmiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$4["sekai-xxmiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$4["sekai-xxmiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$4["sekai-xxmiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$4["sekai-xxmiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    id: "xo-miku-dialog-buttons",
    className: styles$4['sekai-xxmiku-button']
  }, buttonsProps)))))), portalContainer);
};
...
var _excluded$1 = ["sekai", "themeMode", "open", "onClose", "children", "containerComponent", "pos"];
...
var Drawer = function Drawer(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    className: clsx(globalStyles["sekai-overlay-".concat(modeTheme)], styles$3['sekai-drawer'], styles$3[displayDrawer]),
    "aria-hidden": "true",
    onClick: onClose
  }, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$3["sekai-drawer-contents-".concat(pos)], styles$3[displayDrawer], rest.className),
...
export { Accordion, BasicButton, COLORS_SEKAI_KEYS, Card, CardContent, CardTitle, DARK_MODE, Dialog, DialogButtons, DialogTitleHeader, Drawer, HamburgerButton, LIGHT_MODE, List, ListContext, ListItemButton, ListItemText, NamePlate, OutlineText, PrskLinkCard, StickyNote, StrongButton, TextLink, XoMikuDialog, XxMikuDialog, YourSekaiContext, YourSekaiProvider, colorsSekai, convertHexToRgb, convertHexToRgbMixWithWhite, convertHexToRgba, createSekai, fireOnEnterKey, fireOnEscapeKey, useCreateSekai, useThemeMode };
