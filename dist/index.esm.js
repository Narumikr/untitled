...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$o(_objectSpread$o({}, pre), {}, {
        palette: _objectSpread$o(_objectSpread$o({}, pre.palette), {}, {
          sekai: sekai
        })
      });
    });
...
var Accordion = function Accordion(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$n['sekai-accordion-container'], rest.className),
    style: _objectSpread$n(_objectSpread$n({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$n['sekai-accordion-summary'], globalStyles["sekai-color-".concat(modeTheme)], summaryStyles),
    onClick: handleOpenClose,
    id: "accordion-summary",
    "aria-expanded": openAccordion,
    "aria-controls": "details-contents"
  }, /*#__PURE__*/React.createElement("p", {
    className: styles$n['sekai-accordion-summary-text']
  }, summary), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$n["sekai-accordion-summary-icon"], openAccordion ? styles$n['sekai-icon-open'] : styles$n['sekai-icon-close']),
    sekai: sekai,
    themeMode: themeMode,
    vector: "up"
  })), /*#__PURE__*/React.createElement("hr", {
    className: styles$n['sekai-web-horizon']
...
var AccordionDetailsContents = function AccordionDetailsContents(_ref2) {
  ...
  var animationDetailsStyles = _objectSpread$n(_objectSpread$n({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$n['sekai-accordion-details'],
...
var BasicButton = function BasicButton(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    isLight = _useOptionalSekai.isLight;
  var sekaiColorHover = convertHexToRgba(sekaiColor, isLight ? 0.1 : 0.3);
  var optionStyle = _objectSpread$m({
    '--sekai-color': sekaiColor,
    '--sekai-color-hover': sekaiColorHover
  }, withText && {
    color: sekaiColor
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$m["sekai-basic-button-".concat(modeTheme)], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var HamburgerButton = function HamburgerButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$l["sekai-hamburger-button-".concat(modeTheme)], rest.className),
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      className: clsx(styles$l['sekai-hamburger-line'], open && styles$l['sekai-open'])
    });
  }));
};
...
var ScrollTopButton = function ScrollTopButton(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("button", _extends({}, rest, {
    className: clsx(styles$k["sekai-scroll-top-button-".concat(pos)], rest.className),
    style: _objectSpread$k(_objectSpread$k({}, optionStyle), rest.style),
    onClick: handleScroll
  }), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$k['sekai-scroll-top-icon']),
    sekai: sekai,
    themeMode: themeMode
  })), document.body);
};
...
var StrongButton = function StrongButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$j["sekai-strong-button-".concat(modeTheme)], rest.className),
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$h['sekai-card'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var CardContent = function CardContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$h['sekai-card-content'], globalStyles["sekai-color-".concat(modeTheme)], rest.className)
  }), children);
};
var CardTitle = function CardTitle(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("h3", _extends({}, rest, {
    className: clsx(styles$h['sekai-card-title'], globalStyles["sekai-color-".concat(modeTheme)], underline && styles$h['sekai-underline'], rest.className),
    style: _objectSpread$h(_objectSpread$h({}, optionStyle), rest.style)
  }), title);
};
...
var NamePlate = function NamePlate(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$g["sekai-name-plate-".concat(modeTheme)], rest.className),
    style: _objectSpread$g(_objectSpread$g({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("span", {
    className: styles$g['sekai-name-plate-color']
...
var OutlineText = function OutlineText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, rest, {
    className: clsx(styles$f["sekai-outline-text-".concat(modeTheme)], rest.className),
...
var PrskLinkCard = function PrskLinkCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, _extends({}, rest, {
    ...
    className: clsx(styles$e['sekai-prsk-link-card-button'], globalStyles["sekai-color-".concat(modeTheme)]),
    style: (cardSizeStyle),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(NamePlate, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-title"),
    className: clsx(styles$e['sekai-prsk-link-card-title'], styles$e["sekai-title-effect-".concat(modeTheme)]),
    sekai: sekai,
    themeMode: themeMode,
    text: title
  }), /*#__PURE__*/React.createElement(OutlineText, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-subtext"),
    className: styles$e['sekai-prsk-link-card-subtext'],
    sekai: sekai,
    themeMode: themeMode,
    text: subText
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$e['sekai-prsk-link-card-icon']
...
var css_248z$d = ".CommonComponents-module_sekai-dialog-visible__hheii {\n  display: block;\n}\n\n.CommonComponents-module_sekai-dialog-hidden__eu6kA {\n  display: none;\n}";
var styles$d = {"sekai-dialog-visible":"CommonComponents-module_sekai-dialog-visible__hheii","sekai-dialog-hidden":"CommonComponents-module_sekai-dialog-hidden__eu6kA"};
...
var DialogOverlay = function DialogOverlay(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    modeTheme = _useOptionalSekai.modeTheme;
  var optionStyle = _objectSpread$e({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/React.createElement("div", {
    className: styles$d[displayDialog]
  }, /*#__PURE__*/React.createElement("div", {
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], globalStyles['sekai-absolute-center'], styles$c["sekai-container-".concat(size)], rest.className),
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$c["sekai-title-header-".concat(size)], rest.className)
  }), /*#__PURE__*/React.createElement("h2", null, title), showCloseIcon ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: styles$c['sekai-close-icon'],
    onClick: onClose
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$c['sekai-buttons-area'], rest.className)
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$c["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$c["sekai-".concat(modeTheme)], el.buttonStyle || ''),
      style: optionStyle
    }, el.text);
  }));
};
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  var xoButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$c(_objectSpread$c({}, button), {}, {
        buttonStyle: [styles$b["sekai-xomiku-".concat(type, "-button")]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$b["sekai-container-".concat(size)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$b["sekai-xomiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$b["sekai-xomiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$b["sekai-xomiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$b["sekai-xomiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$b["sekai-xomiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$b['sekai-xomiku-button']
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  var xxButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$b(_objectSpread$b({}, button), {}, {
        buttonStyle: [styles$a["sekai-xxmiku-".concat(type, "-button")], styles$a["sekai-".concat(modeTheme)]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$a["sekai-container-".concat(size)], styles$a["sekai-".concat(modeTheme)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$a["sekai-xxmiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$a["sekai-xxmiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$a["sekai-xxmiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$a["sekai-xxmiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$a["sekai-xxmiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    id: "xo-miku-dialog-buttons",
    className: styles$a['sekai-xxmiku-button']
  }, buttonsProps))))), portalContainer);
};
...
var Drawer = function Drawer(_ref) {
  ...
  var posAbsoluteStyle = _objectSpread$a({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    className: clsx(globalStyles["sekai-overlay-".concat(modeTheme)], styles$9['sekai-drawer'], styles$9[displayDrawer]),
    style: posAbsoluteStyle,
    "aria-hidden": "true",
    onClick: onClose
  }, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$9["sekai-drawer-contents-".concat(pos)], styles$9[displayDrawer], rest.className),
...
var DropdownContent = function DropdownContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: wrapDropdownRef,
    className: clsx(styles$8["sekai-dropdown-".concat(modeTheme)], rest.className),
    ...
    style: _objectSpread$9(_objectSpread$9({}, optionStyle), dropdownPosStyle),
    sekai: sekai,
    themeMode: themeMode,
    options: options,
    onSelect: onSelect
...
var DropdownTriggerButton = /*#__PURE__*/forwardRef(function (_ref4, ref) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ref: ref,
    type: "button",
    className: styles$8["sekai-dropdown-trigger-".concat(modeTheme)],
    onClick: handleClick,
    style: optionStyle
  }, /*#__PURE__*/React.createElement("span", {
    className: clsx(_defineProperty({}, styles$8['sekai-placeholder'], isDispPlaceholder))
  }, displayText), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$8['sekai-dropdown-icon'], _defineProperty(_defineProperty({}, styles$8['sekai-dropdown-icon-open'], openOptions), styles$8["sekai-dropdown-icon-close"], !openOptions)),
    sekai: sekai,
    themeMode: themeMode,
    vector: "down"
  }));
...
var DropdownOptions = function DropdownOptions(_ref6) {
  ...
  return isRendered ? /*#__PURE__*/React.createElement("ul", {
    className: clsx(styles$8['sekai-dropdown-options-list'], _defineProperty(_defineProperty({}, styles$8['sekai-dropdown-options-open'], isVisible), styles$8['sekai-dropdown-options-close'], !isVisible), globalStyles["sekai-color-".concat(modeTheme)]),
    style: _objectSpread$9(_objectSpread$9({}, optionStyle), style)
  }, options.map(function (option) {
    return /*#__PURE__*/React.createElement("li", {
      key: option.value,
      className: clsx(styles$8['sekai-dropdown-option-item'])
    }, /*#__PURE__*/React.createElement("button", {
...
var DoReMeetEffect = function DoReMeetEffect(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    ...
    className: clsx(styles$7["sekai-doremeet-effect-".concat(modeTheme)], rest.className),
...
var styles$6 = {"into-the-sekai":"IntoTheSekai-module_into-the-sekai__GYjaM"};
styleInject(css_248z$6);

var _excluded$6 = ["execEvent", "containerComponent"];
...
var IntoTheSekai = function IntoTheSekai(_ref) {
  ...
  var optionStyle = _objectSpread$7({}, containerComponent && {
    position: 'absolute'
  });
  useEffect(function () {
  ...
  useEffect(function () {
    ...
    var _render = function render() {
      ...
      sekaiPieceRef.current = sekaiPieceRef.current.map(function (tri) {
        ...
        return _objectSpread$7(_objectSpread$7({}, tri), {}, {
          points: newPoints,
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("canvas", _extends({}, rest, {
    className: clsx(styles$6['into-the-sekai'], rest.className),
...
var TextLink = function TextLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", _extends({}, rest, {
    className: clsx(styles$5["sekai-text-link-".concat(modeTheme)], disabled && styles$5['sekai-disabled'], rest.className),
...
var List = function List(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ListContext.Provider, {
    ...
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$4['sekai-list'], rest.className),
...
var ListItemButton = function ListItemButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    id: id,
    className: clsx(styles$4['sekai-list-item-button'], className),
    style: _objectSpread$4(_objectSpread$4({}, optionStyle), style)
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    ref: listItemButtonRef,
    className: styles$4["sekai-list-button-".concat(modeTheme)],
    disabled: disabled,
...
var getImgComponent$1 = function getImgComponent(icon) {
  ...
  if (typeof icon === 'string') {
    return /*#__PURE__*/React.createElement("img", {
      className: styles$4['sekai-list-icon'],
      src: icon,
      alt: ""
    });
  } else {
...
var createRippleEffect = function createRippleEffect(x, y, size) {
  ...
  ripple.className = styles$4["".concat(rippleEffectClassName)];
  return ripple;
};
...
var _excluded$3 = ["sekai", "themeMode", "children", "as", "icon"];
...
var ListItemText = function ListItemText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", _extends({}, rest, {
    className: clsx(styles$4['sekai-list-item-text'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var css_248z$3 = ".StickyNote-module_sekai-sticky-note__rheDG,\n.StickyNote-module_sekai-sticky-note__rheDG > button {\n  padding-left: 0;\n  padding-right: 0;\n}\n\n.StickyNote-module_sekai-sticky-note-parts__7ixUr {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  height: 100%;\n  background-color: var(--sekai-color-bg);\n  padding-right: 8px;\n}\n.StickyNote-module_sekai-sticky-note-parts__7ixUr .StickyNote-module_sekai-sticky-note-design__Aae2S {\n  width: 15px;\n  height: 100%;\n  background-color: var(--sekai-color);\n  margin-right: 8px;\n}";
var styles$3 = {"sekai-sticky-note":"StickyNote-module_sekai-sticky-note__rheDG","sekai-sticky-note-parts":"StickyNote-module_sekai-sticky-note-parts__7ixUr","sekai-sticky-note-design":"StickyNote-module_sekai-sticky-note-design__Aae2S"};
styleInject(css_248z$3);

var _excluded$2 = ["sekai", "children", "as"];
var StickyNote = function StickyNote(_ref) {
  ...
  return 'button' === as ? /*#__PURE__*/React.createElement(ListItemButton, _extends({}, rest, {
    className: clsx(styles$3['sekai-sticky-note'], rest.className),
    sekai: sekai,
    themeMode: LIGHT_MODE
...
var Loading = function Loading(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    role: "status",
    "aria-live": "polite",
    className: clsx(styles$2['sekai-loading'], className),
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: clsx(styles$2['sekai-loading-circle'], styles$2["sekai-circle-animation-".concat(index)])
    });
  }));
};
...
var Pagination = function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$1["sekai-pagination-".concat(size)], rest.className),
    ...
    if (item === PaginationConstants.Ellipsis) {
      return /*#__PURE__*/React.createElement("span", {
        key: index,
        className: styles$1['sekai-pagination-ellipsis']
      }, '...');
    }
    return /*#__PURE__*/React.createElement("button", {
      key: index,
      className: clsx(styles$1["sekai-pagination-button-".concat(size)], styles$1["sekai-color-".concat(modeTheme)], _defineProperty({}, styles$1["sekai-pagination-selected"], item === currentPage)),
      onClick: function onClick() {
...
var CtrlButton = function CtrlButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$1["sekai-pagination-button-".concat(size)]),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(ArrowSvg, _extends({}, rest, {
    vector: vector,
    className: styles$1['sekai-pagination-arrow']
  })));
};
...
export { Accordion, BasicButton, BodyText, COLORS_SEKAI_KEYS, Card, CardContent, CardTitle, DARK_MODE, Dialog, DialogButtons, DialogTitleHeader, DoReMeetEffect, Drawer, Dropdown, DropdownContent, HamburgerButton, IntoTheSekai, LIGHT_MODE, List, ListContext, ListItemButton, ListItemText, Loading, NamePlate, ORIENTATION, OutlineText, Pagination, PrskLinkCard, ScrollTopButton, SekaiBodyText, StickyNote, StrongButton, StylishButton, TextLink, XoMikuDialog, XxMikuDialog, YourSekaiContext, YourSekaiProvider, colorsSekai, convertHexToRgb, convertHexToRgbMixWithWhite, convertHexToRgba, createSekai, fireOnEnterKey, fireOnEscapeKey, useCreateSekai, useInnerSize, useOrientation, useTabletSize, useThemeMode };
