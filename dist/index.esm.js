...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$q(_objectSpread$q({}, pre), {}, {
        palette: _objectSpread$q(_objectSpread$q({}, pre.palette), {}, {
          sekai: sekai
        })
      });
    });
...
var convertHexToRgbMixWithBlackOrWhite = function convertHexToRgbMixWithBlackOrWhite(hex, alpha, mixWhite) {
  if (!/^#([0-9A-Fa-f]{6})$/.test(hex)) {
    throw new Error('Invalid hex color format. Use #RRGGBB');
  }
  if (alpha < 0 || alpha > 1) {
  ...
  var mixR = Math.round(r * alpha + mixColor * (1 - alpha));
  var mixG = Math.round(g * alpha + mixColor * (1 - alpha));
  var mixB = Math.round(b * alpha + mixColor * (1 - alpha));
...
var Accordion = function Accordion(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$p['sekai-accordion-container'], rest.className),
    style: _objectSpread$p(_objectSpread$p({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$p['sekai-accordion-summary'], globalStyles["sekai-color-".concat(modeTheme)], summaryStyles),
    onClick: handleOpenClose,
    id: "accordion-summary",
    "aria-expanded": openAccordion,
    "aria-controls": "details-contents"
  }, /*#__PURE__*/React.createElement("p", {
    className: styles$p['sekai-accordion-summary-text']
  }, summary), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$p["sekai-accordion-summary-icon"], openAccordion ? styles$p['sekai-icon-open'] : styles$p['sekai-icon-close']),
    sekai: sekai,
    themeMode: themeMode,
    vector: "up"
  })), /*#__PURE__*/React.createElement("hr", {
    className: styles$p['sekai-web-horizon']
...
var AccordionDetailsContents = function AccordionDetailsContents(_ref2) {
  ...
  var animationDetailsStyles = _objectSpread$p(_objectSpread$p({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$p['sekai-accordion-details'],
...
var BasicButton = function BasicButton(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    isLight = _useOptionalSekai.isLight;
  var sekaiColorHover = convertHexToRgba(sekaiColor, isLight ? 0.1 : 0.3);
  var optionStyle = _objectSpread$o({
    '--sekai-color': sekaiColor,
    '--sekai-color-hover': sekaiColorHover
  }, withText && {
    color: sekaiColor
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$o["sekai-basic-button-".concat(modeTheme)], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var HamburgerButton = function HamburgerButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$n["sekai-hamburger-button-".concat(modeTheme)], rest.className),
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      className: clsx(styles$n['sekai-hamburger-line'], open && styles$n['sekai-open'])
    });
  }));
};
...
var ScrollTopButton = function ScrollTopButton(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    sekaiColor = _useOptionalSekai.sekaiColor,
    isLight = _useOptionalSekai.isLight;
  var sekaiColorBg = convertHexToRgbMixWithBlackOrWhite(sekaiColor, 0.5, isLight);
  var optionStyle = {
    '--sekai-color': sekaiColor,
    '--sekai-color-bg': sekaiColorBg
  };
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("button", _extends({}, rest, {
    className: clsx(styles$m["sekai-scroll-top-button-".concat(pos)], rest.className),
    style: _objectSpread$m(_objectSpread$m({}, optionStyle), rest.style),
    onClick: handleScroll
  }), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$m['sekai-scroll-top-icon']),
    sekai: sekai,
    themeMode: themeMode
  })), document.body);
};
...
var StrongButton = function StrongButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$l["sekai-strong-button-".concat(modeTheme)], rest.className),
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$j['sekai-card'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var CardContent = function CardContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$j['sekai-card-content'], globalStyles["sekai-color-".concat(modeTheme)], rest.className)
  }), children);
};
var CardTitle = function CardTitle(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("h3", _extends({}, rest, {
    className: clsx(styles$j['sekai-card-title'], globalStyles["sekai-color-".concat(modeTheme)], underline && styles$j['sekai-underline'], rest.className),
    style: _objectSpread$j(_objectSpread$j({}, optionStyle), rest.style)
  }), title);
};
...
var NamePlate = function NamePlate(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$i["sekai-name-plate-".concat(modeTheme)], rest.className),
    style: _objectSpread$i(_objectSpread$i({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("span", {
    className: styles$i['sekai-name-plate-color']
...
var OutlineText = function OutlineText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, rest, {
    className: clsx(styles$h["sekai-outline-text-".concat(modeTheme)], rest.className),
...
var PrskLinkCard = function PrskLinkCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, _extends({}, rest, {
    ...
    className: clsx(styles$g['sekai-prsk-link-card-button'], globalStyles["sekai-color-".concat(modeTheme)]),
    style: (cardSizeStyle),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(NamePlate, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-title"),
    className: clsx(styles$g['sekai-prsk-link-card-title'], styles$g["sekai-title-effect-".concat(modeTheme)]),
    sekai: sekai,
    themeMode: themeMode,
    text: title
  }), /*#__PURE__*/React.createElement(OutlineText, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-subtext"),
    className: styles$g['sekai-prsk-link-card-subtext'],
    sekai: sekai,
    themeMode: themeMode,
    text: subText
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$g['sekai-prsk-link-card-icon']
...
var css_248z$f = ".CommonComponents-module_sekai-dialog-visible__hheii {\n  display: block;\n}\n\n.CommonComponents-module_sekai-dialog-hidden__eu6kA {\n  display: none;\n}";
var styles$f = {"sekai-dialog-visible":"CommonComponents-module_sekai-dialog-visible__hheii","sekai-dialog-hidden":"CommonComponents-module_sekai-dialog-hidden__eu6kA"};
...
var DialogOverlay = function DialogOverlay(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    modeTheme = _useOptionalSekai.modeTheme;
  var optionStyle = _objectSpread$g({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/React.createElement("div", {
    className: styles$f[displayDialog]
  }, /*#__PURE__*/React.createElement("div", {
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], globalStyles['sekai-absolute-center'], styles$e["sekai-container-".concat(size)], rest.className),
    style: _objectSpread$f(_objectSpread$f({}, optionStyle), rest.style),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$e['sekai-content-wrap']
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$e["sekai-title-header-".concat(size)], rest.className)
  }), /*#__PURE__*/React.createElement("h2", null, title), showCloseIcon ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: styles$e['sekai-close-icon'],
    onClick: onClose
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$e['sekai-buttons-area'], rest.className)
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$e["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$e["sekai-".concat(modeTheme)], el.buttonStyle || ''),
      style: optionStyle
    }, el.text);
  }));
};
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  var xoButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$e(_objectSpread$e({}, button), {}, {
        buttonStyle: [styles$d["sekai-xomiku-".concat(type, "-button")]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$d["sekai-container-".concat(size)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$d["sekai-xomiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$d["sekai-xomiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$d["sekai-xomiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$d["sekai-xomiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$d["sekai-xomiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$d['sekai-content-wrap']
    ...
    className: styles$d['sekai-xomiku-button']
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  var xxButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      var type = button.type ? button.type : 'normal';
      return _objectSpread$d(_objectSpread$d({}, button), {}, {
        buttonStyle: [styles$c["sekai-xxmiku-".concat(type, "-button")], styles$c["sekai-".concat(modeTheme)]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$c["sekai-container-".concat(size)], styles$c["sekai-".concat(modeTheme)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$c["sekai-xxmiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$c["sekai-xxmiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$c["sekai-xxmiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$c["sekai-xxmiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$c["sekai-xxmiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$c['sekai-content-wrap']
  }, /*#__PURE__*/React.createElement(DialogTitleHeader, _extends({
    id: "xo-miku-dialog-header"
  }, headerProps)), children, /*#__PURE__*/React.createElement(DialogButtons, _extends({
    id: "xo-miku-dialog-buttons",
    className: styles$c['sekai-xxmiku-button']
  }, buttonsProps))))), portalContainer);
};
...
var Drawer = function Drawer(_ref) {
  ...
  var posAbsoluteStyle = _objectSpread$c({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    className: clsx(globalStyles["sekai-overlay-".concat(modeTheme)], styles$b['sekai-drawer'], styles$b[displayDrawer]),
    style: posAbsoluteStyle,
    "aria-hidden": "true",
    onClick: onClose
  }, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$b["sekai-drawer-contents-".concat(pos)], styles$b[displayDrawer], rest.className),
...
var DropdownContent = function DropdownContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: wrapDropdownRef,
    className: clsx(styles$a["sekai-dropdown-".concat(modeTheme)], rest.className),
    ...
    style: _objectSpread$b(_objectSpread$b({}, optionStyle), dropdownPosStyle),
    sekai: sekai,
    themeMode: themeMode,
    options: options,
    onSelect: onSelect
...
var DropdownTriggerButton = /*#__PURE__*/forwardRef(function (_ref4, ref) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ref: ref,
    type: "button",
    className: styles$a["sekai-dropdown-trigger-".concat(modeTheme)],
    onClick: handleClick,
    style: optionStyle
  }, /*#__PURE__*/React.createElement("span", {
    className: clsx(_defineProperty({}, styles$a['sekai-placeholder'], isDispPlaceholder))
  }, displayText), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$a['sekai-dropdown-icon'], _defineProperty(_defineProperty({}, styles$a['sekai-dropdown-icon-open'], openOptions), styles$a["sekai-dropdown-icon-close"], !openOptions)),
    sekai: sekai,
    themeMode: themeMode,
    vector: "down"
  }));
...
var DropdownOptions = function DropdownOptions(_ref6) {
  ...
  var sekaiColorShadow = convertHexToRgbMixWithBlackOrWhite(sekaiColor, 0.5, isLight);
  var sekaiColorHover = convertHexToRgba(sekaiColor, isLight ? 0.1 : 0.3);
  var optionStyle = {
    '--sekai-color': sekaiColor,
  ...
  return isRendered ? /*#__PURE__*/React.createElement("ul", {
    className: clsx(styles$a['sekai-dropdown-options-list'], _defineProperty(_defineProperty({}, styles$a['sekai-dropdown-options-open'], isVisible), styles$a['sekai-dropdown-options-close'], !isVisible), globalStyles["sekai-color-".concat(modeTheme)]),
    style: _objectSpread$b(_objectSpread$b({}, optionStyle), style)
  }, options.map(function (option) {
    return /*#__PURE__*/React.createElement("li", {
      key: option.value,
      className: clsx(styles$a['sekai-dropdown-option-item'])
    }, /*#__PURE__*/React.createElement("button", {
...
var DoReMeetEffect = function DoReMeetEffect(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    ...
    className: clsx(styles$9["sekai-doremeet-effect-".concat(modeTheme)], rest.className),
...
var styles$8 = {"into-the-sekai":"IntoTheSekai-module_into-the-sekai__GYjaM"};
styleInject(css_248z$8);

var _excluded$8 = ["execEvent", "containerComponent"];
...
var IntoTheSekai = function IntoTheSekai(_ref) {
  ...
  var optionStyle = _objectSpread$9({}, containerComponent && {
    position: 'absolute'
  });
  useEffect(function () {
  ...
  useEffect(function () {
    ...
    var _render = function render() {
      ...
      sekaiPieceRef.current = sekaiPieceRef.current.map(function (tri) {
        ...
        return _objectSpread$9(_objectSpread$9({}, tri), {}, {
          points: newPoints,
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("canvas", _extends({}, rest, {
    className: clsx(styles$8['into-the-sekai'], rest.className),
...
var TextLink = function TextLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", _extends({}, rest, {
    className: clsx(styles$7["sekai-text-link-".concat(modeTheme)], disabled && styles$7['sekai-disabled'], rest.className),
...
var List = function List(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ListContext.Provider, {
    ...
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$6['sekai-list'], rest.className),
...
var ListItemButton = function ListItemButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    id: id,
    className: clsx(styles$6['sekai-list-item-button'], className),
    style: _objectSpread$6(_objectSpread$6({}, optionStyle), style)
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    ref: listItemButtonRef,
    className: styles$6["sekai-list-button-".concat(modeTheme)],
    disabled: disabled,
...
var getImgComponent$1 = function getImgComponent(icon) {
  ...
  if (typeof icon === 'string') {
    return /*#__PURE__*/React.createElement("img", {
      className: styles$6['sekai-list-icon'],
      src: icon,
      alt: ""
    });
  } else {
...
var createRippleEffect = function createRippleEffect(x, y, size) {
  ...
  ripple.className = styles$6["".concat(rippleEffectClassName)];
  return ripple;
};
...
var _excluded$5 = ["sekai", "themeMode", "children", "as", "icon"];
...
var ListItemText = function ListItemText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", _extends({}, rest, {
    className: clsx(styles$6['sekai-list-item-text'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var css_248z$5 = ".StickyNote-module_sekai-sticky-note__rheDG,\n.StickyNote-module_sekai-sticky-note__rheDG > button {\n  padding-left: 0;\n  padding-right: 0;\n}\n\n.StickyNote-module_sekai-sticky-note-parts__7ixUr {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  height: 100%;\n  background-color: var(--sekai-color-bg);\n  padding-right: 8px;\n}\n.StickyNote-module_sekai-sticky-note-parts__7ixUr .StickyNote-module_sekai-sticky-note-design__Aae2S {\n  width: 15px;\n  height: 100%;\n  background-color: var(--sekai-color);\n  margin-right: 8px;\n}";
var styles$5 = {"sekai-sticky-note":"StickyNote-module_sekai-sticky-note__rheDG","sekai-sticky-note-parts":"StickyNote-module_sekai-sticky-note-parts__7ixUr","sekai-sticky-note-design":"StickyNote-module_sekai-sticky-note-design__Aae2S"};
styleInject(css_248z$5);

var _excluded$4 = ["sekai", "children", "as"];
var StickyNote = function StickyNote(_ref) {
  ...
  return 'button' === as ? /*#__PURE__*/React.createElement(ListItemButton, _extends({}, rest, {
    className: clsx(styles$5['sekai-sticky-note'], rest.className),
    sekai: sekai,
    themeMode: LIGHT_MODE
...
var Loading = function Loading(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    role: "status",
    "aria-live": "polite",
    className: clsx(styles$4['sekai-loading'], className),
    style: _objectSpread$4(_objectSpread$4({}, optionStyle), style)
  }, Array.from({
    length: CIRCLE_COUNT
  }, function (_, index) {
    return /*#__PURE__*/React.createElement("div", {
      key: "circle-".concat(index),
      className: clsx(styles$4['sekai-loading-circle'], styles$4["sekai-circle-animation-".concat(index)])
    });
  }));
};
...
var Pagination = function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$3["sekai-pagination-".concat(size)], rest.className),
    ...
    if (item === PaginationConstants.Ellipsis) {
      return /*#__PURE__*/React.createElement("span", {
        key: index,
        className: styles$3['sekai-pagination-ellipsis']
      }, '...');
    }
    return /*#__PURE__*/React.createElement("button", {
      key: index,
      className: clsx(styles$3["sekai-pagination-button-".concat(size)], styles$3["sekai-color-".concat(modeTheme)], _defineProperty({}, styles$3["sekai-pagination-selected"], item === currentPage)),
      onClick: function onClick() {
...
var CtrlButton = function CtrlButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$3["sekai-pagination-button-".concat(size)]),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(ArrowSvg, _extends({}, rest, {
    vector: vector,
    className: styles$3['sekai-pagination-arrow']
  })));
};
...
var BodyText = function BodyText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("p", _extends({}, rest, {
    className: clsx(styles$2["sekai-body-text-".concat(modeTheme)], isPortrait ? globalStyles['text-sm'] : globalStyles['text-base'], rest.className)
  }), children);
};
var SekaiBodyText = function SekaiBodyText(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(BodyText, _extends({}, rest, {
    style: _objectSpread$2(_objectSpread$2({}, colorStyle), rest.style)
  }), children);
};
var DetailText = function DetailText(_ref3) {
  ...
  var _useOptionalSekai3 = useOptionalSekai({
    ...
    modeTheme = _useOptionalSekai3.modeTheme;
  return /*#__PURE__*/React.createElement("p", _extends({}, rest, {
    className: clsx(styles$2["sekai-detail-text-".concat(modeTheme)], globalStyles['text-xs'], rest.className)
  }), children);
};
...
var AnnotationText = function AnnotationText(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(DetailText, _extends({}, rest, {
    className: clsx(styles$2["sekai-annotation-text-".concat(modeTheme)], rest.className)
  }), children);
};
var SekaiAnnotationText = function SekaiAnnotationText(_ref6) {
  ...
  var annotationColor = convertHexToRgbMixWithBlackOrWhite(sekaiColor, 0.7, isLight);
  var colorStyle = {
...
var TextField = function TextField(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: id,
    className: clsx(styles$1['sekai-textfield'], className),
    style: _objectSpread$1(_objectSpread$1({}, optionStyle), style)
  }, /*#__PURE__*/React.createElement("div", {
    className: clsx(styles$1['sekai-textfield-wrapper'])
  }, /*#__PURE__*/React.createElement("input", _extends({
    id: "".concat(id, "-input"),
    type: "text"
  }, inputProps, {
    className: clsx(styles$1["sekai-textfield-input-".concat(modeTheme)], _defineProperty({}, styles$1['sekai-textfield-clear'], clearButton)),
    value: inputValue,
    onChange: handleInputChange
  })), clearButton && inputValue.length ? /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$1['sekai-textfield-clear-button']),
    onClick: handleClearInput
  }, /*#__PURE__*/React.createElement(ClearSvg, {
    className: clsx(styles$1['sekai-textfield-clear-icon']),
    sekai: sekai,
    themeMode: themeMode
  })) : null), isError ? /*#__PURE__*/React.createElement(AnnotationText, {
    className: clsx(styles$1['sekai-textfield-input-error'])
  }, errorMessage) : null);
};
...
var Tooltip = function Tooltip(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    modeTheme = _useOptionalSekai.modeTheme,
    isLight = _useOptionalSekai.isLight;
  var sekaiColorBg = convertHexToRgbMixWithBlackOrWhite(sekaiColor, 0.2, isLight);
  var optionStyle = {
    '--sekai-color': sekaiColor,
    '--sekai-color-bg': sekaiColorBg
  };
...
export { Accordion, AnnotationText, BasicButton, BodyText, COLORS_SEKAI_KEYS, Card, CardContent, CardTitle, DARK_MODE, DetailText, Dialog, DialogButtons, DialogTitleHeader, DoReMeetEffect, Drawer, Dropdown, DropdownContent, HamburgerButton, IntoTheSekai, LIGHT_MODE, List, ListContext, ListItemButton, ListItemText, Loading, NamePlate, ORIENTATION, OutlineText, Pagination, PrskLinkCard, ScrollTopButton, SekaiAnnotationText, SekaiBodyText, SekaiDetailText, StickyNote, StrongButton, StylishButton, TextField, TextLink, Tooltip, XoMikuDialog, XxMikuDialog, YourSekaiContext, YourSekaiProvider, colorsSekai, convertHexToRgb, convertHexToRgbMixWithBlackOrWhite, convertHexToRgba, createSekai, fireOnEnterKey, fireOnEscapeKey, shuffleArray, useCreateSekai, useInnerSize, useOrientation, useTabletSize, useThemeMode };
