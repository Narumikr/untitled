import React, { useRef, useState, useEffect, memo, useMemo, createContext, useCallback, useContext, forwardRef, Children, isValidElement } from 'react';
...
var MarqueeText = function MarqueeText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: containerRef,
    className: clsx(styles$5['sekai-marquee-text'], _defineProperty(_defineProperty({}, styles$5['sekai-marquee-text-scroll'], excessiveLength), styles$5['sekai-marquee-text-wrap-comp'], /*#__PURE__*/isValidElement(children)), rest.className),
