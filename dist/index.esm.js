...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$5(_objectSpread$5({}, pre), {}, {
        palette: _objectSpread$5(_objectSpread$5({}, pre.palette), {}, {
          sekai: sekai
        })
      });
    });
...
var Accordion = function Accordion(_ref) {
  var _ref$className = _ref.className,
    ...
    _ref$summaryStyles = _ref.summaryStyles,
    summaryStyles = _ref$summaryStyles === void 0 ? '' : _ref$summaryStyles,
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: [styles$a['sekai-accordion-container'], className].join(' '),
    style: optionStyle
  }, /*#__PURE__*/React.createElement("button", {
    className: [styles$a['sekai-accordion-summary'], globalStyles["sekai-color-".concat(modeTheme)], summaryStyles].join(' '),
    onClick: handleOpenClose,
    id: "accordion-summary",
    "aria-expanded": openAccordion,
    "aria-controls": "details-contents"
  }, /*#__PURE__*/React.createElement("p", {
    className: styles$a['sekai-accordion-summary-text']
  }, summary), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: [styles$a["sekai-accordion-summary-icon"], openAccordion ? styles$a['sekai-icon-open'] : styles$a['sekai-icon-close']].join(' '),
    sekai: sekai,
    themeMode: themeMode,
    vector: "up"
  })), /*#__PURE__*/React.createElement("hr", {
    className: styles$a['sekai-web-horizon']
...
var AccordionDetailsContents = function AccordionDetailsContents(_ref2) {
  ...
  var animationDetailsStyles = _objectSpread$4(_objectSpread$4({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$a['sekai-accordion-details'],
...
var DetailText = function DetailText(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("p", {
    className: styles$a['sekai-detail-text']
  }, text);
};
...
var BasicButton = function BasicButton(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    isLight = _useOptionalSekai.isLight;
  var sekaiColorHover = convertHexToRgba(sekaiColor, isLight ? 0.1 : 0.3);
  var optionStyle = _objectSpread$3({
    '--sekai-color': sekaiColor,
    '--sekai-color-hover': sekaiColorHover
  }, withText && {
    color: sekaiColor
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    className: [styles$9["sekai-basic-button-".concat(modeTheme)], globalStyles["sekai-color-".concat(modeTheme)], className].join(' '),
    style: optionStyle,
    disabled: disabled
...
var StrongButton = function StrongButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    className: [styles$8["sekai-strong-button-".concat(modeTheme)], className].join(' '),
    style: optionStyle,
    disabled: disabled
  }, buttonProps), children);
};

var css_248z$7 = ".Card-module_sekai-card__yjfwU {\n  box-shadow: 0px 2px 1px -1px var(--sekai-color-shadow), 0px 1px 1px 0px var(--sekai-color-shadow), 0px 1px 3px 0px var(--sekai-color-shadow);\n  border-radius: 5px;\n}\n\n.Card-module_sekai-card-content__XtdPc {\n  padding: 16px;\n}\n\n.Card-module_sekai-card-title__Os2hg {\n  margin: 0;\n}\n.Card-module_sekai-card-title__Os2hg.Card-module_sekai-underline__oP8Wv {\n  text-decoration: underline;\n  text-decoration-color: var(--sekai-color);\n}";
var styles$7 = {"sekai-card":"Card-module_sekai-card__yjfwU","sekai-card-content":"Card-module_sekai-card-content__XtdPc","sekai-card-title":"Card-module_sekai-card-title__Os2hg","sekai-underline":"Card-module_sekai-underline__oP8Wv"};
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: [styles$7['sekai-card'], globalStyles["sekai-color-".concat(modeTheme)], className].join(' '),
    style: optionStyle
  }, children);
};
var CardContent = function CardContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: [styles$7['sekai-card-content'], globalStyles["sekai-color-".concat(modeTheme)], className].join(' ')
  }, children);
};
var CardTitle = function CardTitle(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("h3", {
    className: [styles$7['sekai-card-title'], globalStyles["sekai-color-".concat(modeTheme)], underline && styles$7['sekai-underline'], className].join(' '),
    style: optionStyle
  }, title);
};
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    role: "dialog",
    className: [globalStyles["sekai-color-".concat(modeTheme)], globalStyles['sekai-absolute-center'], styles$6["sekai-container-".concat(size)]].join(' '),
    style: optionStyle,
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: [styles$6["sekai-title-header-".concat(size)], className].join(' ')
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: [styles$6['sekai-buttons-area'], className].join(' ')
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: [globalStyles["sekai-color-".concat(modeTheme)], styles$6["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$6["sekai-".concat(modeTheme)], el.buttonStyle || ''].join(' '),
      style: optionStyle
    }, el.text);
  }));
};
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  var xxButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$2(_objectSpread$2({}, button), {}, {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    role: "dialog",
    className: [globalStyles['sekai-absolute-center'], styles$5["sekai-container-".concat(size)]].join(' '),
    "aria-label": title || 'Dialog'
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  var xxButtonProps = useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      var type = button.type ? button.type : 'normal';
      return _objectSpread$1(_objectSpread$1({}, button), {}, {
  ...
  return /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    role: "dialog",
    className: [globalStyles['sekai-absolute-center'], styles$4["sekai-container-".concat(size)], styles$4["sekai-".concat(modeTheme)]].join(' '),
    "aria-label": title || 'Dialog'
...
var TextLink = function TextLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", {
    className: [styles$3["sekai-text-link-".concat(modeTheme)], disabled && styles$3['sekai-disabled'], className].join(' '),
    style: optionStyle,
    href: href,
...
var List = function List(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ListContext.Provider, {
    ...
    className: [globalStyles["sekai-color-".concat(modeTheme)], styles$2['sekai-list'], className].join(' '),
    style: _objectSpread({
...
var ListItemButton = function ListItemButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    className: [styles$2['sekai-list-item-button'], className].join(' '),
    style: optionStyle
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
...
var ListItemText = function ListItemText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    className: [styles$2['sekai-list-item-text'], globalStyles["sekai-color-".concat(modeTheme)], className].join(' '),
    style: optionStyle
...
var NamePlate = function NamePlate(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: [styles$1["sekai-name-plate-".concat(modeTheme)], className].join(' '),
    style: optionStyle
  }, /*#__PURE__*/React.createElement("span", {
    className: styles$1['sekai-name-plate-color']
...
export { Accordion, BasicButton, COLORS_SEKAI_KEYS, Card, CardContent, CardTitle, DARK_MODE, Dialog, DialogButtons, DialogTitleHeader, LIGHT_MODE, List, ListContext, ListItemButton, ListItemText, NamePlate, OutlineText, StrongButton, TextLink, XoMikuDialog, XxMikuDialog, YourSekaiContext, YourSekaiProvider, colorsSekai, convertHexToRgb, convertHexToRgba, createSekai, fireOnEnterKey, fireOnEscapeKey, useCreateSekai, useThemeMode };
