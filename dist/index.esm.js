...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$4(_objectSpread$4({}, pre), {}, {
        palette: _objectSpread$4(_objectSpread$4({}, pre.palette), {}, {
          sekai: sekai
        })
      });
    });
...
export { BasicButton, COLORS_SEKAI_KEYS, DARK_MODE, Dialog, DialogButtons, DialogTitleHeader, LIGHT_MODE, List, ListContext, ListItemButton, ListItemText, NamePlate, OutlineText, StrongButton, TextLink, XoMikuDialog, XxMikuDialog, YourSekaiContext, YourSekaiProvider, colorsSekai, convertHexToRgb, convertHexToRgba, createSekai, fireOnEnterKey, fireOnEscapeKey, useCreateSekai, useThemeMode };
