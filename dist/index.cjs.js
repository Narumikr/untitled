...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var currentSekaiTheme = React.useMemo(function () {
    return _objectSpread$v(_objectSpread$v({}, sekaiTheme), {}, {
      palette: _objectSpread$v(_objectSpread$v({}, sekaiTheme.palette), {}, {
        sekai: sekaiColor,
        mode: colorTheme
      })
    });
...
var Accordion = function Accordion(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$u['sekai-accordion-container'], rest.className),
    style: _objectSpread$u(_objectSpread$u({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$u['sekai-accordion-summary'], globalStyles["sekai-color-".concat(modeTheme)], summaryStyles),
    onClick: handleOpenClose,
    id: "accordion-summary",
    "aria-expanded": openAccordion,
    "aria-controls": "details-contents"
  }, /*#__PURE__*/React.createElement("p", {
    className: styles$u['sekai-accordion-summary-text']
  }, summary), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$u["sekai-accordion-summary-icon"], openAccordion ? styles$u['sekai-icon-open'] : styles$u['sekai-icon-close']),
    sekai: sekai,
    themeMode: themeMode,
    vector: "up"
  })), /*#__PURE__*/React.createElement("hr", {
    className: styles$u['sekai-web-horizon']
...
var AccordionDetailsContents = function AccordionDetailsContents(_ref2) {
  ...
  var animationDetailsStyles = _objectSpread$u(_objectSpread$u({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$u['sekai-accordion-details'],
...
var DetailText$1 = function DetailText(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("p", {
    className: styles$u['sekai-detail-text']
  }, text);
};

var css_248z$t = ".Backdrop-module_sekai-backdrop-visible__WBf2v {\n  display: block;\n}\n\n.Backdrop-module_sekai-backdrop-hidden__VY-ZG {\n  display: none;\n}\n\n.Backdrop-module_sekai-backdrop-bg__-4uxN {\n  background: var(--sekai-color-bg);\n}\n\n.Backdrop-module_sekai-backdrop-centered__KN6ki {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n}";
var styles$t = {"sekai-backdrop-visible":"Backdrop-module_sekai-backdrop-visible__WBf2v","sekai-backdrop-hidden":"Backdrop-module_sekai-backdrop-hidden__VY-ZG","sekai-backdrop-bg":"Backdrop-module_sekai-backdrop-bg__-4uxN","sekai-backdrop-centered":"Backdrop-module_sekai-backdrop-centered__KN6ki"};
styleInject(css_248z$t);

var _excluded$t = ["sekai", "themeMode", "open", "children", "containerComponent", "centered"];
...
var BasicButton = function BasicButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$s["sekai-basic-button-".concat(modeTheme)], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var HamburgerButton = function HamburgerButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$r["sekai-hamburger-button-".concat(modeTheme)], rest.className),
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      className: clsx(styles$r['sekai-hamburger-line'], open && styles$r['sekai-open'])
    });
  }));
};
...
var ScrollTopButton = function ScrollTopButton(_ref) {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement("button", _extends({}, rest, {
    className: clsx(styles$q["sekai-scroll-top-button-".concat(pos)], rest.className),
    style: _objectSpread$q(_objectSpread$q({}, optionStyle), rest.style),
    onClick: handleScroll
  }), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$q['sekai-scroll-top-icon']),
    sekai: sekai,
    themeMode: themeMode
  })), document.body);
};
...
var StrongButton = function StrongButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$p["sekai-strong-button-".concat(modeTheme)], rest.className),
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$n['sekai-card'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var CardContent = function CardContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$n['sekai-card-content'], globalStyles["sekai-color-".concat(modeTheme)], rest.className)
  }), children);
};
var CardTitle = function CardTitle(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("h3", _extends({}, rest, {
    className: clsx(styles$n['sekai-card-title'], globalStyles["sekai-color-".concat(modeTheme)], underline && styles$n['sekai-underline'], rest.className),
    style: _objectSpread$n(_objectSpread$n({}, optionStyle), rest.style)
  }), title);
};
...
var NamePlate = function NamePlate(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$m["sekai-name-plate-".concat(modeTheme)], rest.className),
    style: _objectSpread$m(_objectSpread$m({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("span", {
    className: styles$m['sekai-name-plate-color']
...
var OutlineText = function OutlineText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, rest, {
    className: clsx(styles$l["sekai-outline-text-".concat(modeTheme)], rest.className),
...
var PrskLinkCard = function PrskLinkCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, _extends({}, rest, {
    ...
    className: clsx(styles$k['sekai-prsk-link-card-button'], globalStyles["sekai-color-".concat(modeTheme)]),
    style: (cardSizeStyle),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(NamePlate, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-title"),
    className: clsx(styles$k['sekai-prsk-link-card-title'], styles$k["sekai-title-effect-".concat(modeTheme)]),
    sekai: sekai,
    themeMode: themeMode,
    text: title
  }), /*#__PURE__*/React.createElement(OutlineText, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-subtext"),
    className: styles$k['sekai-prsk-link-card-subtext'],
    sekai: sekai,
    themeMode: themeMode,
    text: subText
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$k['sekai-prsk-link-card-icon']
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(Backdrop, _extends({}, overlayProps, {
    ...
    role: "dialog",
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$j["sekai-container-".concat(size)], rest.className),
    style: _objectSpread$k(_objectSpread$k({}, optionStyle), rest.style),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$j['sekai-content-wrap']
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$j["sekai-title-header-".concat(size)], rest.className)
  }), /*#__PURE__*/React.createElement("h2", null, title), showCloseIcon ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: styles$j['sekai-close-icon'],
    onClick: onClose
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$j['sekai-buttons-area'], rest.className)
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$j["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$j["sekai-".concat(modeTheme)], el.buttonStyle || ''),
      style: optionStyle
    }, el.text);
  }));
};
...
var WindowDialog = function WindowDialog(_ref) {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: modalRef,
    role: "dialog",
    className: clsx(styles$i["sekai-window-dialog-".concat(modeTheme)], _defineProperty(_defineProperty({}, styles$i["sekai-window-dialog-size-".concat(size)], !isFullscreen), styles$i['sekai-window-dialog-fullscreen'], isFullscreen), styles$i[displayDialog], rest.className),
    ...
    className: clsx(styles$i['sekai-window-dialog-container'])
  }, children)), portalContainer);
};
var WindowHeader = function WindowHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    role: "button",
    tabIndex: 0,
    className: styles$i['sekai-window-dialog-header'],
    onMouseDown: onMouseDown
  }, /*#__PURE__*/React.createElement("button", {
    className: styles$i['sekai-window-dialog-button'],
    onClick: onClick
  }, isFullscreen ? /*#__PURE__*/React.createElement(RestoreSvg, _extends({}, rest, {
    className: clsx(styles$i['sekai-window-dialog-icon'])
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  var xoButtonProps = React.useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$i(_objectSpread$i({}, button), {}, {
        buttonStyle: clsx(styles$h["sekai-xomiku-".concat(type, "-button")])
      });
    });
  }, [buttons]);
  var overlayProps = {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(Backdrop, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(styles$h["sekai-container-".concat(size)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$h["sekai-xomiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$h["sekai-xomiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$h["sekai-xomiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$h["sekai-xomiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$h["sekai-xomiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$h['sekai-xomiku-button']
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  var xxButtonProps = React.useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$h(_objectSpread$h({}, button), {}, {
        buttonStyle: clsx(styles$g["sekai-xxmiku-".concat(type, "-button")], styles$g["sekai-".concat(modeTheme)])
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(Backdrop, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(styles$g["sekai-container-".concat(size)], styles$g["sekai-".concat(modeTheme)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$g["sekai-xxmiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$g["sekai-xxmiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$g["sekai-xxmiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$g["sekai-xxmiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$g["sekai-xxmiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    id: "xo-miku-dialog-buttons",
    className: styles$g['sekai-xxmiku-button']
  }, buttonsProps))))), portalContainer);
};
...
var Divider = function Divider(_ref) {
  ...
  var shadowStyle = Boolean(shadow) ? styles$f["sekai-divider-shadow-".concat(modeTheme)] : '';
  var optionStyle = React.useMemo(function () {
    return {
      '--sekai-color': sekaiColor,
      '--sekai-pair-color': gradientColor,
      '--divider-line-height': lineheight ? "".concat(lineheight, "px") : LIGHTHEIGHT
    };
  }, [sekaiColor, gradientColor, lineheight]);
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$f["sekai-divider-".concat(variant)], rest.className),
    style: _objectSpread$g(_objectSpread$g({}, optionStyle), rest.style)
  }), children ? /*#__PURE__*/React.createElement("div", {
    className: clsx(styles$f["sekai-divider-with-item-".concat(textAlign)], shadowStyle)
  }, children) : /*#__PURE__*/React.createElement("hr", {
    className: clsx(styles$f['sekai-divider-line'], shadowStyle)
  }));
};
