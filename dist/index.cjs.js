 ...
 * If global.css is changed, please update these values accordingly.
 */
// provider text color
var COLOR_LIGHT_MODE = '#212121';
var COLOR_DARK_MODE = '#e0e0e0';
// provider background color
var BACKGROUND_LIGHT_MODE = '#ffffff';
var BACKGROUND_DARK_MODE = '#121212';
...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var currentSekaiTheme = React.useMemo(function () {
    return _objectSpread$w(_objectSpread$w({}, sekaiTheme), {}, {
      palette: _objectSpread$w(_objectSpread$w({}, sekaiTheme.palette), {}, {
        sekai: sekaiColor,
        mode: colorTheme
      })
    });
...
var Accordion = function Accordion(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$v['sekai-accordion-container'], rest.className),
    style: _objectSpread$v(_objectSpread$v({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$v['sekai-accordion-summary'], globalStyles["sekai-color-".concat(modeTheme)], summaryStyles),
    onClick: handleOpenClose,
    id: "accordion-summary",
    "aria-expanded": openAccordion,
    "aria-controls": "details-contents"
  }, /*#__PURE__*/React.createElement("p", {
    className: styles$v['sekai-accordion-summary-text']
  }, summary), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$v["sekai-accordion-summary-icon"], openAccordion ? styles$v['sekai-icon-open'] : styles$v['sekai-icon-close']),
    sekai: sekai,
    themeMode: themeMode,
    vector: "up"
  })), /*#__PURE__*/React.createElement("hr", {
    className: styles$v['sekai-web-horizon']
...
var AccordionDetailsContents = function AccordionDetailsContents(_ref2) {
  ...
  var animationDetailsStyles = _objectSpread$v(_objectSpread$v({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$v['sekai-accordion-details'],
...
var DetailText$1 = function DetailText(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("p", {
    className: styles$v['sekai-detail-text']
  }, text);
};

var css_248z$u = ".Backdrop-module_sekai-backdrop-visible__WBf2v {\n  display: block;\n}\n\n.Backdrop-module_sekai-backdrop-hidden__VY-ZG {\n  display: none;\n}\n\n.Backdrop-module_sekai-backdrop-bg__-4uxN {\n  background: var(--sekai-color-bg);\n}\n\n.Backdrop-module_sekai-backdrop-centered__KN6ki {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n}";
var styles$u = {"sekai-backdrop-visible":"Backdrop-module_sekai-backdrop-visible__WBf2v","sekai-backdrop-hidden":"Backdrop-module_sekai-backdrop-hidden__VY-ZG","sekai-backdrop-bg":"Backdrop-module_sekai-backdrop-bg__-4uxN","sekai-backdrop-centered":"Backdrop-module_sekai-backdrop-centered__KN6ki"};
styleInject(css_248z$u);

var _excluded$u = ["sekai", "themeMode", "open", "children", "containerComponent", "centered"];
...
var BasicButton = function BasicButton(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    isLight = _useOptionalSekai.isLight;
  var sekaiColorHover = convertHexToRgba(sekaiColor, isLight ? 0.1 : 0.3);
  var optionStyle = _objectSpread$t({
    '--sekai-color': sekaiColor,
    '--sekai-color-hover': sekaiColorHover
  }, withText && {
    color: sekaiColor
...
var HamburgerButton = function HamburgerButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$s["sekai-hamburger-button-".concat(modeTheme)], rest.className),
...
var StrongButton = function StrongButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$q["sekai-strong-button-".concat(modeTheme)], rest.className),
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$o['sekai-card'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var CardContent = function CardContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$o['sekai-card-content'], globalStyles["sekai-color-".concat(modeTheme)], rest.className)
  }), children);
};
...
var OutlineText = function OutlineText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, rest, {
    className: clsx(styles$m["sekai-outline-text-".concat(modeTheme)], rest.className),
...
var PrskLinkCard = function PrskLinkCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, _extends({}, rest, {
    ...
    className: clsx(styles$l['sekai-prsk-link-card-button'], globalStyles["sekai-color-".concat(modeTheme)]),
    style: (cardSizeStyle),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(NamePlate, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-title"),
    className: clsx(styles$l['sekai-prsk-link-card-title'], styles$l["sekai-title-effect-".concat(modeTheme)]),
    sekai: sekai,
    themeMode: themeMode,
    text: title
  }), /*#__PURE__*/React.createElement(OutlineText, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-subtext"),
    className: styles$l['sekai-prsk-link-card-subtext'],
    sekai: sekai,
    themeMode: themeMode,
    text: subText
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$l['sekai-prsk-link-card-icon']
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(Backdrop, _extends({}, overlayProps, {
    centered: true
  }), /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$k["sekai-container-".concat(size)], rest.className),
    style: _objectSpread$l(_objectSpread$l({}, optionStyle), rest.style),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$k['sekai-content-wrap']
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$k["sekai-title-header-".concat(size)], rest.className)
  }), /*#__PURE__*/React.createElement("h2", null, title), showCloseIcon ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: styles$k['sekai-close-icon'],
    onClick: onClose
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$k['sekai-buttons-area'], rest.className)
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$k["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$k["sekai-".concat(modeTheme)], el.buttonStyle || ''),
      style: optionStyle
    }, el.text);
  }));
};
...
var WindowDialog = function WindowDialog(_ref) {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: modalRef,
    role: "dialog",
    className: clsx(styles$j["sekai-window-dialog-".concat(modeTheme)], _defineProperty(_defineProperty({}, styles$j["sekai-window-dialog-size-".concat(size)], !isFullscreen), styles$j['sekai-window-dialog-fullscreen'], isFullscreen), styles$j[displayDialog], rest.className),
    ...
    className: clsx(styles$j['sekai-window-dialog-container'])
  }, children)), portalContainer);
};
var WindowHeader = function WindowHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    role: "button",
    tabIndex: 0,
    className: styles$j['sekai-window-dialog-header'],
    onMouseDown: onMouseDown
  }, /*#__PURE__*/React.createElement("button", {
    className: styles$j['sekai-window-dialog-button'],
    onClick: onClick
  }, isFullscreen ? /*#__PURE__*/React.createElement(RestoreSvg, _extends({}, rest, {
    className: clsx(styles$j['sekai-window-dialog-icon'])
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  var xoButtonProps = React.useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$j(_objectSpread$j({}, button), {}, {
        buttonStyle: clsx(styles$i["sekai-xomiku-".concat(type, "-button")])
      });
    });
  }, [buttons]);
  var overlayProps = {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(Backdrop, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(styles$i["sekai-container-".concat(size)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$i["sekai-xomiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$i["sekai-xomiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$i["sekai-xomiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$i["sekai-xomiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$i["sekai-xomiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$i['sekai-xomiku-button']
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  var xxButtonProps = React.useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      var type = button.type ? button.type : 'normal';
      return _objectSpread$i(_objectSpread$i({}, button), {}, {
        buttonStyle: clsx(styles$h["sekai-xxmiku-".concat(type, "-button")], styles$h["sekai-".concat(modeTheme)])
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(Backdrop, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(styles$h["sekai-container-".concat(size)], styles$h["sekai-".concat(modeTheme)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$h["sekai-xxmiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$h["sekai-xxmiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$h["sekai-xxmiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$h["sekai-xxmiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$h["sekai-xxmiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$h['sekai-content-wrap']
  }, /*#__PURE__*/React.createElement(DialogTitleHeader, _extends({
    id: "xo-miku-dialog-header"
  }, headerProps)), children, /*#__PURE__*/React.createElement(DialogButtons, _extends({
    id: "xo-miku-dialog-buttons",
    className: styles$h['sekai-xxmiku-button']
  }, buttonsProps))))), portalContainer);
};

var css_248z$g = "/* Styles for common color */\n/* Styles for z-index */\n/* Styles for common classes */\n.Divider-module_sekai-text-light__fX6m0 {\n  color: #212121;\n}\n\n.Divider-module_sekai-text-dark__ShgnF {\n  color: #e0e0e0;\n}\n\n.Divider-module_sekai-color-light__SBhSN {\n  color: #212121;\n  background-color: #ffffff;\n}\n\n.Divider-module_sekai-color-dark__lgNYk {\n  color: #e0e0e0;\n  background-color: #121212;\n}\n\n.Divider-module_sekai-overlay__FH2-I, .Divider-module_sekai-overlay-dark__Y-rLo, .Divider-module_sekai-overlay-light__zt2H7 {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 1000;\n}\n\n.Divider-module_sekai-overlay-light__zt2H7 {\n  background-color: rgba(0, 0, 0, 0.3882352941);\n}\n\n.Divider-module_sekai-overlay-dark__Y-rLo {\n  background-color: rgba(255, 255, 255, 0.3019607843);\n}\n\n/* Styles for positioning */\n.Divider-module_sekai-flex-center__3sHhG {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.Divider-module_sekai-absolute-center__mvluV {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n\n/* Styles for scroll */\n.Divider-module_sekai-invisible-scroll__A4gYt {\n  overflow-y: scroll;\n  scrollbar-width: none;\n}\n.Divider-module_sekai-invisible-scroll__A4gYt::-webkit-scrollbar {\n  display: none;\n}\n\n/* Styles for margin space */\n.Divider-module_sekai-mb-8__-zEju {\n  margin-bottom: 8px;\n}\n\n.Divider-module_sekai-mb-16__XaEz- {\n  margin-bottom: 16px;\n}\n\n.Divider-module_sekai-mb-24__LGL4b {\n  margin-bottom: 24px;\n}\n\n.Divider-module_text-responsible-body__Lhh6k {\n  font-size: 16px;\n}\n\n@media (min-width: 768px) {\n  .Divider-module_text-responsible-body__Lhh6k {\n    font-size: 14px;\n  }\n}\n.Divider-module_text-xs__txjJQ {\n  font-size: 12px;\n}\n\n.Divider-module_text-sm__MWJcV {\n  font-size: 14px;\n}\n\n.Divider-module_text-base__oj6jJ {\n  font-size: 16px;\n}\n\n.Divider-module_text-lg__3Xmhf {\n  font-size: 18px;\n}\n\n.Divider-module_text-xl__2Fp4U {\n  font-size: 20px;\n}\n\n.Divider-module_text-2xl__GHP87 {\n  font-size: 24px;\n}\n\n.Divider-module_text-base-bold__g10Fk {\n  font-size: 16px;\n  font-weight: bold;\n}\n\n.Divider-module_text-lg-bold__2eHgl {\n  font-size: 18px;\n  font-weight: bold;\n}\n\n.Divider-module_text-xl-bold__0YNqp {\n  font-size: 20px;\n  font-weight: bold;\n}\n\n.Divider-module_text-2xl-bold__PERb- {\n  font-size: 24px;\n  font-weight: bold;\n}\n\n.Divider-module_font-bold__V5D3J {\n  font-weight: bold;\n}\n\n.Divider-module_sekai-divider__qfuz6, .Divider-module_sekai-divider-middle__f2HkC, .Divider-module_sekai-divider-inset__JKixd, .Divider-module_sekai-divider-fullWidth__mAV3d {\n  display: flex;\n  position: relative;\n  justify-content: center;\n  align-items: center;\n  margin: 8px 0;\n  height: -moz-fit-content;\n  height: fit-content;\n}\n\n.Divider-module_sekai-divider-fullWidth__mAV3d {\n  width: 100%;\n}\n\n.Divider-module_sekai-divider-inset__JKixd {\n  width: 100%;\n  padding-left: 72px;\n}\n\n.Divider-module_sekai-divider-middle__f2HkC {\n  width: 100%;\n  padding-left: 16px;\n  padding-right: 16px;\n}\n\n.Divider-module_sekai-divider-line__t5gpU {\n  width: 100%;\n  border: none;\n  margin: 0;\n  height: var(--divider-line-height);\n  background: linear-gradient(45deg, var(--sekai-color), var(--sekai-pair-color));\n}\n.Divider-module_sekai-divider-line__t5gpU.Divider-module_sekai-divider-shadow-light__AraMc {\n  box-shadow: 0 1px 3px 0 rgb(183.9, 183.9, 183.9), 0 1px 1px 0 rgb(160.2, 160.2, 160.2), 0 2px 1px -1px rgb(136.5, 136.5, 136.5);\n}\n.Divider-module_sekai-divider-line__t5gpU.Divider-module_sekai-divider-shadow-dark__oP-AJ {\n  box-shadow: 0 1px 3px 0 rgb(76.5, 76.5, 76.5), 0 1px 1px 0 #666666, 0 2px 1px -1px rgb(127.5, 127.5, 127.5);\n}\n\n.Divider-module_sekai-divider-with-item__o9ObD, .Divider-module_sekai-divider-with-item-right__ZjNOp, .Divider-module_sekai-divider-with-item-left__Vdz9q, .Divider-module_sekai-divider-with-item-center__da8-R {\n  display: flex;\n  align-items: center;\n  width: 100%;\n}\n.Divider-module_sekai-divider-with-item__o9ObD::before, .Divider-module_sekai-divider-with-item-right__ZjNOp::before, .Divider-module_sekai-divider-with-item-left__Vdz9q::before, .Divider-module_sekai-divider-with-item-center__da8-R::before {\n  content: \"\";\n  height: var(--divider-line-height);\n  background: linear-gradient(45deg, var(--sekai-color), var(--sekai-pair-color));\n  margin-right: 16px;\n}\n.Divider-module_sekai-divider-with-item__o9ObD::after, .Divider-module_sekai-divider-with-item-right__ZjNOp::after, .Divider-module_sekai-divider-with-item-left__Vdz9q::after, .Divider-module_sekai-divider-with-item-center__da8-R::after {\n  content: \"\";\n  height: var(--divider-line-height);\n  background: linear-gradient(45deg, var(--sekai-pair-color), var(--sekai-color));\n  margin-left: 16px;\n}\n.Divider-module_sekai-divider-with-item__o9ObD.Divider-module_sekai-divider-shadow-light__AraMc::before, .Divider-module_sekai-divider-shadow-light__AraMc.Divider-module_sekai-divider-with-item-right__ZjNOp::before, .Divider-module_sekai-divider-shadow-light__AraMc.Divider-module_sekai-divider-with-item-left__Vdz9q::before, .Divider-module_sekai-divider-shadow-light__AraMc.Divider-module_sekai-divider-with-item-center__da8-R::before, .Divider-module_sekai-divider-with-item__o9ObD.Divider-module_sekai-divider-shadow-light__AraMc::after, .Divider-module_sekai-divider-shadow-light__AraMc.Divider-module_sekai-divider-with-item-right__ZjNOp::after, .Divider-module_sekai-divider-shadow-light__AraMc.Divider-module_sekai-divider-with-item-left__Vdz9q::after, .Divider-module_sekai-divider-shadow-light__AraMc.Divider-module_sekai-divider-with-item-center__da8-R::after {\n  box-shadow: 0 1px 3px 0 rgb(183.9, 183.9, 183.9), 0 1px 1px 0 rgb(160.2, 160.2, 160.2), 0 2px 1px -1px rgb(136.5, 136.5, 136.5);\n}\n.Divider-module_sekai-divider-with-item__o9ObD.Divider-module_sekai-divider-shadow-dark__oP-AJ::before, .Divider-module_sekai-divider-shadow-dark__oP-AJ.Divider-module_sekai-divider-with-item-right__ZjNOp::before, .Divider-module_sekai-divider-shadow-dark__oP-AJ.Divider-module_sekai-divider-with-item-left__Vdz9q::before, .Divider-module_sekai-divider-shadow-dark__oP-AJ.Divider-module_sekai-divider-with-item-center__da8-R::before, .Divider-module_sekai-divider-with-item__o9ObD.Divider-module_sekai-divider-shadow-dark__oP-AJ::after, .Divider-module_sekai-divider-shadow-dark__oP-AJ.Divider-module_sekai-divider-with-item-right__ZjNOp::after, .Divider-module_sekai-divider-shadow-dark__oP-AJ.Divider-module_sekai-divider-with-item-left__Vdz9q::after, .Divider-module_sekai-divider-shadow-dark__oP-AJ.Divider-module_sekai-divider-with-item-center__da8-R::after {\n  box-shadow: 0 1px 3px 0 rgb(76.5, 76.5, 76.5), 0 1px 1px 0 #666666, 0 2px 1px -1px rgb(127.5, 127.5, 127.5);\n}\n\n.Divider-module_sekai-divider-with-item-center__da8-R::before, .Divider-module_sekai-divider-with-item-center__da8-R::after {\n  flex: 1;\n}\n\n.Divider-module_sekai-divider-with-item-left__Vdz9q::before {\n  flex: 1;\n}\n.Divider-module_sekai-divider-with-item-left__Vdz9q::after {\n  flex: 3;\n}\n\n.Divider-module_sekai-divider-with-item-right__ZjNOp::before {\n  flex: 3;\n}\n.Divider-module_sekai-divider-with-item-right__ZjNOp::after {\n  flex: 1;\n}";
var styles$g = {"sekai-text-light":"Divider-module_sekai-text-light__fX6m0","sekai-text-dark":"Divider-module_sekai-text-dark__ShgnF","sekai-color-light":"Divider-module_sekai-color-light__SBhSN","sekai-color-dark":"Divider-module_sekai-color-dark__lgNYk","sekai-overlay":"Divider-module_sekai-overlay__FH2-I","sekai-overlay-dark":"Divider-module_sekai-overlay-dark__Y-rLo","sekai-overlay-light":"Divider-module_sekai-overlay-light__zt2H7","sekai-flex-center":"Divider-module_sekai-flex-center__3sHhG","sekai-absolute-center":"Divider-module_sekai-absolute-center__mvluV","sekai-invisible-scroll":"Divider-module_sekai-invisible-scroll__A4gYt","sekai-mb-8":"Divider-module_sekai-mb-8__-zEju","sekai-mb-16":"Divider-module_sekai-mb-16__XaEz-","sekai-mb-24":"Divider-module_sekai-mb-24__LGL4b","text-responsible-body":"Divider-module_text-responsible-body__Lhh6k","text-xs":"Divider-module_text-xs__txjJQ","text-sm":"Divider-module_text-sm__MWJcV","text-base":"Divider-module_text-base__oj6jJ","text-lg":"Divider-module_text-lg__3Xmhf","text-xl":"Divider-module_text-xl__2Fp4U","text-2xl":"Divider-module_text-2xl__GHP87","text-base-bold":"Divider-module_text-base-bold__g10Fk","text-lg-bold":"Divider-module_text-lg-bold__2eHgl","text-xl-bold":"Divider-module_text-xl-bold__0YNqp","text-2xl-bold":"Divider-module_text-2xl-bold__PERb-","font-bold":"Divider-module_font-bold__V5D3J","sekai-divider":"Divider-module_sekai-divider__qfuz6","sekai-divider-middle":"Divider-module_sekai-divider-middle__f2HkC","sekai-divider-inset":"Divider-module_sekai-divider-inset__JKixd","sekai-divider-fullWidth":"Divider-module_sekai-divider-fullWidth__mAV3d","sekai-divider-line":"Divider-module_sekai-divider-line__t5gpU","sekai-divider-shadow-light":"Divider-module_sekai-divider-shadow-light__AraMc","sekai-divider-shadow-dark":"Divider-module_sekai-divider-shadow-dark__oP-AJ","sekai-divider-with-item":"Divider-module_sekai-divider-with-item__o9ObD","sekai-divider-with-item-right":"Divider-module_sekai-divider-with-item-right__ZjNOp","sekai-divider-with-item-left":"Divider-module_sekai-divider-with-item-left__Vdz9q","sekai-divider-with-item-center":"Divider-module_sekai-divider-with-item-center__da8-R"};
styleInject(css_248z$g);

var _excluded$g = ["sekai", "themeMode", "children", "pairColor", "lineHeight", "variant", "textAlign", "shadow"];
...
var Divider = function Divider(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    sekaiColor = _useOptionalSekai.sekaiColor,
    modeTheme = _useOptionalSekai.modeTheme;
  var gradientColor = pairColor ? colorsSekai[pairColor] : 'transparent';
  var shadowStyle = Boolean(shadow) ? styles$g["sekai-divider-shadow-".concat(modeTheme)] : '';
  var optionStyle = {
    '--sekai-color': sekaiColor,
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$g["sekai-divider-".concat(variant)], rest.className),
    style: _objectSpread$h(_objectSpread$h({}, optionStyle), rest.style)
  }), children ? /*#__PURE__*/React.createElement("div", {
    role: "separator",
    "aria-orientation": "horizontal",
    className: clsx(styles$g["sekai-divider-with-item-".concat(textAlign)], shadowStyle)
  }, children) : /*#__PURE__*/React.createElement("hr", {
    role: "separator",
    "aria-orientation": "horizontal",
    className: clsx(styles$g['sekai-divider-line'], shadowStyle)
  }));
};
...
var Drawer = function Drawer(_ref) {
  ...
  var posAbsoluteStyle = _objectSpread$g({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement("div", {
    className: clsx(globalStyles["sekai-overlay-".concat(modeTheme)], styles$f['sekai-drawer'], styles$f[displayDrawer]),
    style: posAbsoluteStyle,
    "aria-hidden": "true",
    onClick: onClose
  }, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$f["sekai-drawer-contents-".concat(pos)], styles$f[displayDrawer], rest.className),
...
var DropdownContent = function DropdownContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: wrapDropdownRef,
    className: clsx(styles$e["sekai-dropdown-".concat(modeTheme)], rest.className),
    ...
    style: _objectSpread$f(_objectSpread$f({}, optionStyle), dropdownPosStyle),
    sekai: sekai,
    themeMode: themeMode,
    options: options,
    onSelect: onSelect
...
var DropdownTriggerButton = /*#__PURE__*/React.forwardRef(function (_ref4, ref) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ref: ref,
    type: "button",
    className: styles$e["sekai-dropdown-trigger-".concat(modeTheme)],
    onClick: handleClick,
    style: optionStyle
  }, /*#__PURE__*/React.createElement("span", {
    className: clsx(_defineProperty({}, styles$e['sekai-placeholder'], isDispPlaceholder))
  }, displayText), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$e['sekai-dropdown-icon'], _defineProperty(_defineProperty({}, styles$e['sekai-dropdown-icon-open'], openOptions), styles$e["sekai-dropdown-icon-close"], !openOptions)),
    sekai: sekai,
    themeMode: themeMode,
    vector: "down"
  }));
...
var DropdownOptions = function DropdownOptions(_ref6) {
  ...
  return isRendered ? /*#__PURE__*/React.createElement("ul", {
    className: clsx(styles$e['sekai-dropdown-options-list'], _defineProperty(_defineProperty({}, styles$e['sekai-dropdown-options-open'], isVisible), styles$e['sekai-dropdown-options-close'], !isVisible), globalStyles["sekai-color-".concat(modeTheme)]),
    style: _objectSpread$f(_objectSpread$f({}, optionStyle), style)
  }, options.map(function (option) {
    return /*#__PURE__*/React.createElement("li", {
      key: option.value,
      className: clsx(styles$e['sekai-dropdown-option-item'])
    }, /*#__PURE__*/React.createElement("button", {
...
var DoReMeetEffect = function DoReMeetEffect(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    modeTheme = _useOptionalSekai.modeTheme;
  var INIT_VALUE = -1;
  var _useState = React.useState(INIT_VALUE),
    _useState2 = _slicedToArray(_useState, 2),
...
var IntoTheSekai = function IntoTheSekai(_ref) {
  ...
  React.useEffect(function () {
    ...
    var _render = function render() {
      ...
      sekaiPieceRef.current = sekaiPieceRef.current.map(function (tri) {
        ...
        return _objectSpread$d(_objectSpread$d({}, tri), {}, {
          points: newPoints,
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement("canvas", _extends({}, rest, {
    className: clsx(styles$c['into-the-sekai'], rest.className),
...
var TextLink = function TextLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", _extends({}, rest, {
    className: clsx(styles$b["sekai-text-link-".concat(modeTheme)], disabled && styles$b['sekai-disabled'], rest.className),
...
var List = function List(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ListContext.Provider, {
    ...
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$a['sekai-list'], rest.className),
...
var ListItemButton = function ListItemButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    id: id,
    className: clsx(styles$a['sekai-list-item-button'], className),
    style: _objectSpread$a(_objectSpread$a({}, optionStyle), style)
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    ref: listItemButtonRef,
    className: styles$a["sekai-list-button-".concat(modeTheme)],
    disabled: disabled,
...
var getImgComponent$1 = function getImgComponent(icon) {
  ...
  if (typeof icon === 'string') {
    return /*#__PURE__*/React.createElement("img", {
      className: styles$a['sekai-list-icon'],
      src: icon,
      alt: ""
    });
  } else {
...
var createRippleEffect = function createRippleEffect(x, y, size) {
  ...
  ripple.className = styles$a["".concat(rippleEffectClassName)];
  return ripple;
};
...
var _excluded$9 = ["sekai", "themeMode", "children", "as", "icon"];
...
var ListItemText = function ListItemText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", _extends({}, rest, {
    className: clsx(styles$a['sekai-list-item-text'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var css_248z$9 = ".StickyNote-module_sekai-sticky-note__rheDG,\n.StickyNote-module_sekai-sticky-note__rheDG > button {\n  padding-left: 0;\n  padding-right: 0;\n}\n\n.StickyNote-module_sekai-sticky-note-parts__7ixUr {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  height: 100%;\n  background-color: var(--sekai-color-bg);\n  padding-right: 8px;\n}\n.StickyNote-module_sekai-sticky-note-parts__7ixUr .StickyNote-module_sekai-sticky-note-design__Aae2S {\n  width: 15px;\n  height: 100%;\n  background-color: var(--sekai-color);\n  margin-right: 8px;\n}";
var styles$9 = {"sekai-sticky-note":"StickyNote-module_sekai-sticky-note__rheDG","sekai-sticky-note-parts":"StickyNote-module_sekai-sticky-note-parts__7ixUr","sekai-sticky-note-design":"StickyNote-module_sekai-sticky-note-design__Aae2S"};
styleInject(css_248z$9);

var _excluded$8 = ["sekai", "children", "as"];
var StickyNote = function StickyNote(_ref) {
  ...
  return 'button' === as ? /*#__PURE__*/React.createElement(ListItemButton, _extends({}, rest, {
    className: clsx(styles$9['sekai-sticky-note'], rest.className),
    sekai: sekai,
    themeMode: LIGHT_MODE
...
var Loading = function Loading(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    role: "status",
    "aria-live": "polite",
    className: clsx(styles$8['sekai-loading'], className),
...
var Pagination = function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$7["sekai-pagination-".concat(size)], rest.className),
    ...
    if (item === PaginationConstants.Ellipsis) {
      return /*#__PURE__*/React.createElement("span", {
        key: index,
        className: styles$7['sekai-pagination-ellipsis']
      }, '...');
    }
    return /*#__PURE__*/React.createElement("button", {
      key: index,
      className: clsx(styles$7["sekai-pagination-button-".concat(size)], styles$7["sekai-color-".concat(modeTheme)], _defineProperty({}, styles$7["sekai-pagination-selected"], item === currentPage)),
      onClick: function onClick() {
...
var CtrlButton = function CtrlButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$7["sekai-pagination-button-".concat(size)]),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(ArrowSvg, _extends({}, rest, {
    vector: vector,
    className: styles$7['sekai-pagination-arrow']
  })));
};
...
var Checkbox = function Checkbox(_ref) {
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: clsx(styles$6['sekai-checkbox'], rest.className),
    style: _objectSpread$6(_objectSpread$6({}, optionStyle), rest.style)
  }, /*#__PURE__*/React.createElement("input", _extends({}, rest, {
    tabIndex: Boolean(disabled) ? -1 : 0,
    type: "checkbox",
    className: clsx(styles$6["sekai-checkbox-".concat(modeTheme)], _defineProperty({}, styles$6['sekai-checkbox-filling'], filling)),
...
var css_248z$5 = ".MarqueeText-module_sekai-marquee-text__EYrnL {\n  background-color: inherit;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n.MarqueeText-module_sekai-marquee-text-wrap-comp__-Rdyx {\n  position: relative;\n  display: flex;\n}\n.MarqueeText-module_sekai-marquee-text-wrap-comp__-Rdyx::after {\n  content: \"\";\n  position: absolute;\n  top: 0;\n  right: 0;\n  width: 30px;\n  height: 100%;\n  background: linear-gradient(to left, var(--background-color-container) 0%, transparent 100%);\n  pointer-events: none;\n  z-index: 1;\n}\n\n@keyframes MarqueeText-module_textScroll__d056m {\n  0% {\n    transform: translateX(0);\n  }\n  100% {\n    transform: translateX(-100%);\n  }\n}\n.MarqueeText-module_sekai-marquee-text-scroll__mH-ee {\n  max-width: 100%;\n  overflow: hidden;\n}\n.MarqueeText-module_sekai-marquee-text-scroll__mH-ee .MarqueeText-module_sekai-marquee-text-string__kGIMr {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.MarqueeText-module_sekai-marquee-text-scroll__mH-ee:hover .MarqueeText-module_sekai-marquee-text-string__kGIMr,\n.MarqueeText-module_sekai-marquee-text-scroll__mH-ee:hover .MarqueeText-module_sekai-marquee-text-wrap__8bAI0, .MarqueeText-module_sekai-marquee-text-scroll__mH-ee:focus .MarqueeText-module_sekai-marquee-text-string__kGIMr,\n.MarqueeText-module_sekai-marquee-text-scroll__mH-ee:focus .MarqueeText-module_sekai-marquee-text-wrap__8bAI0 {\n  display: inline-block;\n  overflow: visible;\n  animation: MarqueeText-module_textScroll__d056m var(--scroll-duration, 5s) linear infinite;\n}";
var styles$5 = {"sekai-marquee-text":"MarqueeText-module_sekai-marquee-text__EYrnL","sekai-marquee-text-wrap-comp":"MarqueeText-module_sekai-marquee-text-wrap-comp__-Rdyx","sekai-marquee-text-scroll":"MarqueeText-module_sekai-marquee-text-scroll__mH-ee","sekai-marquee-text-string":"MarqueeText-module_sekai-marquee-text-string__kGIMr","sekai-marquee-text-wrap":"MarqueeText-module_sekai-marquee-text-wrap__8bAI0"};
styleInject(css_248z$5);

var _excluded$5 = ["sekai", "themeMode", "children", "duration", "parentBackgroundColor"];
...
var MarqueeText = function MarqueeText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: containerRef,
    className: clsx(styles$5['sekai-marquee-text'], _defineProperty(_defineProperty({}, styles$5['sekai-marquee-text-scroll'], excessiveLength), styles$5['sekai-marquee-text-wrap-comp'], /*#__PURE__*/React.isValidElement(children)), rest.className),
    ...
    className: clsx(styles$5['sekai-marquee-text-wrap'])
  }, clonedChildren) : /*#__PURE__*/React.createElement("span", {
    ref: textWrapRef,
    className: clsx(styles$5['sekai-marquee-text-string'])
  }, children));
};
...
var BodyText = function BodyText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("p", _extends({}, rest, {
    className: clsx(styles$3["sekai-body-text-".concat(modeTheme)], globalStyles['text-responsible-body'], rest.className)
  }), children);
};
...
var useCurrentTime = function useCurrentTime() {
  var _useState = React.useState(getCurrentTime()),
    _useState2 = _slicedToArray(_useState, 2),
...
exports.DoReMeetEffect = DoReMeetEffect;
...
exports.getCustomCurrentTime = getCustomCurrentTime;
