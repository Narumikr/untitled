...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$s(_objectSpread$s({}, pre), {}, {
        palette: _objectSpread$s(_objectSpread$s({}, pre.palette), {}, {
          sekai: sekai
        })
      });
    });
...
var Accordion = function Accordion(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$r['sekai-accordion-container'], rest.className),
    style: _objectSpread$r(_objectSpread$r({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$r['sekai-accordion-summary'], globalStyles["sekai-color-".concat(modeTheme)], summaryStyles),
    onClick: handleOpenClose,
    id: "accordion-summary",
    "aria-expanded": openAccordion,
    "aria-controls": "details-contents"
  }, /*#__PURE__*/React.createElement("p", {
    className: styles$r['sekai-accordion-summary-text']
  }, summary), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$r["sekai-accordion-summary-icon"], openAccordion ? styles$r['sekai-icon-open'] : styles$r['sekai-icon-close']),
    sekai: sekai,
    themeMode: themeMode,
    vector: "up"
  })), /*#__PURE__*/React.createElement("hr", {
    className: styles$r['sekai-web-horizon']
...
var AccordionDetailsContents = function AccordionDetailsContents(_ref2) {
  ...
  var animationDetailsStyles = _objectSpread$r(_objectSpread$r({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$r['sekai-accordion-details'],
...
var BasicButton = function BasicButton(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    isLight = _useOptionalSekai.isLight;
  var sekaiColorHover = convertHexToRgba(sekaiColor, isLight ? 0.1 : 0.3);
  var optionStyle = _objectSpread$q({
    '--sekai-color': sekaiColor,
    '--sekai-color-hover': sekaiColorHover
  }, withText && {
    color: sekaiColor
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$q["sekai-basic-button-".concat(modeTheme)], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var HamburgerButton = function HamburgerButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$p["sekai-hamburger-button-".concat(modeTheme)], rest.className),
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      className: clsx(styles$p['sekai-hamburger-line'], open && styles$p['sekai-open'])
    });
  }));
};
...
var ScrollTopButton = function ScrollTopButton(_ref) {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement("button", _extends({}, rest, {
    className: clsx(styles$o["sekai-scroll-top-button-".concat(pos)], rest.className),
    style: _objectSpread$o(_objectSpread$o({}, optionStyle), rest.style),
    onClick: handleScroll
  }), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$o['sekai-scroll-top-icon']),
    sekai: sekai,
    themeMode: themeMode
  })), document.body);
};
...
var StrongButton = function StrongButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    type: "button",
    className: clsx(styles$n["sekai-strong-button-".concat(modeTheme)], rest.className),
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$l['sekai-card'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var CardContent = function CardContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$l['sekai-card-content'], globalStyles["sekai-color-".concat(modeTheme)], rest.className)
  }), children);
};
var CardTitle = function CardTitle(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("h3", _extends({}, rest, {
    className: clsx(styles$l['sekai-card-title'], globalStyles["sekai-color-".concat(modeTheme)], underline && styles$l['sekai-underline'], rest.className),
    style: _objectSpread$l(_objectSpread$l({}, optionStyle), rest.style)
  }), title);
};
...
var NamePlate = function NamePlate(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$k["sekai-name-plate-".concat(modeTheme)], rest.className),
    style: _objectSpread$k(_objectSpread$k({}, optionStyle), rest.style)
  }), /*#__PURE__*/React.createElement("span", {
    className: styles$k['sekai-name-plate-color']
...
var OutlineText = function OutlineText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, rest, {
    className: clsx(styles$j["sekai-outline-text-".concat(modeTheme)], rest.className),
...
var PrskLinkCard = function PrskLinkCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, _extends({}, rest, {
    ...
    className: clsx(styles$i['sekai-prsk-link-card-button'], globalStyles["sekai-color-".concat(modeTheme)]),
    style: (cardSizeStyle),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(NamePlate, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-title"),
    className: clsx(styles$i['sekai-prsk-link-card-title'], styles$i["sekai-title-effect-".concat(modeTheme)]),
    sekai: sekai,
    themeMode: themeMode,
    text: title
  }), /*#__PURE__*/React.createElement(OutlineText, {
    id: "".concat(rest.id ? rest.id : 'prsk-link-card', "-subtext"),
    className: styles$i['sekai-prsk-link-card-subtext'],
    sekai: sekai,
    themeMode: themeMode,
    text: subText
  }), /*#__PURE__*/React.createElement("div", {
    className: styles$i['sekai-prsk-link-card-icon']
...
var css_248z$h = ".CommonComponents-module_sekai-dialog-visible__hheii {\n  display: block;\n}\n\n.CommonComponents-module_sekai-dialog-hidden__eu6kA {\n  display: none;\n}";
var styles$h = {"sekai-dialog-visible":"CommonComponents-module_sekai-dialog-visible__hheii","sekai-dialog-hidden":"CommonComponents-module_sekai-dialog-hidden__eu6kA"};
...
var DialogOverlay = function DialogOverlay(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    modeTheme = _useOptionalSekai.modeTheme;
  var optionStyle = _objectSpread$i({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/React.createElement("div", {
    className: styles$h[displayDialog]
  }, /*#__PURE__*/React.createElement("div", {
...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], globalStyles['sekai-absolute-center'], styles$g["sekai-container-".concat(size)], rest.className),
...
var DialogTitleHeader = function DialogTitleHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$g["sekai-title-header-".concat(size)], rest.className)
  }), /*#__PURE__*/React.createElement("h2", null, title), showCloseIcon ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: styles$g['sekai-close-icon'],
    onClick: onClose
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$g['sekai-buttons-area'], rest.className)
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$g["sekai-dialog-".concat(el.type || 'normal', "-button-").concat(buttonLength, "-").concat(index)], styles$g["sekai-".concat(modeTheme)], el.buttonStyle || ''),
      style: optionStyle
    }, el.text);
  }));
};
...
var WindowDialog = function WindowDialog(_ref) {
  ...
  var _useOptionalSekai = useOptionalSekai({
    ...
    isLight = _useOptionalSekai.isLight;
  var displayDialog = open ? 'sekai-dialog-visible' : 'sekai-dialog-hidden';
  var sekaiColorBg = convertHexToRgbMixWithBlackOrWhite(sekaiColor, 0.3, isLight);
  var sekaiColorHeader = convertHexToRgbMixWithBlackOrWhite(sekaiColor, 0.5, isLight);
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: modalRef,
    role: "dialog",
    className: clsx(styles$f["sekai-window-dialog-".concat(modeTheme)], _defineProperty(_defineProperty({}, styles$f["sekai-window-dialog-size-".concat(size)], !isFullscreen), styles$f['sekai-window-dialog-fullscreen'], isFullscreen), styles$f[displayDialog], rest.className),
    ...
    className: clsx(styles$f['sekai-window-dialog-container'])
...
var WindowHeader = function WindowHeader(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    role: "button",
    tabIndex: 0,
    className: styles$f['sekai-window-dialog-header'],
    onMouseDown: onMouseDown
  }, /*#__PURE__*/React.createElement("button", {
    className: styles$f['sekai-window-dialog-button'],
    onClick: onClick
  }, isFullscreen ? /*#__PURE__*/React.createElement(RestoreSvg, _extends({}, rest, {
    className: clsx(styles$f['sekai-window-dialog-icon'])
...
var XoMikuDialog = function XoMikuDialog(_ref) {
  ...
  var xoButtonProps = React.useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$f(_objectSpread$f({}, button), {}, {
        buttonStyle: [styles$e["sekai-xomiku-".concat(type, "-button")]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$e["sekai-container-".concat(size)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$e["sekai-xomiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$e["sekai-xomiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$e["sekai-xomiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$e["sekai-xomiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XoMikuSvg, {
    className: styles$e["sekai-xomiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: styles$e['sekai-xomiku-button']
...
var XxMikuDialog = function XxMikuDialog(_ref) {
  ...
  var xxButtonProps = React.useMemo(function () {
    return buttons === null || buttons === void 0 ? void 0 : buttons.map(function (button) {
      ...
      return _objectSpread$e(_objectSpread$e({}, button), {}, {
        buttonStyle: [styles$d["sekai-xxmiku-".concat(type, "-button")], styles$d["sekai-".concat(modeTheme)]].join(' ')
      });
    });
  }, [buttons, modeTheme]);
  var overlayProps = {
  ...
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement(DialogOverlay, overlayProps, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "dialog",
    className: clsx(globalStyles['sekai-absolute-center'], styles$d["sekai-container-".concat(size)], styles$d["sekai-".concat(modeTheme)], rest.className),
    "aria-label": title || 'Dialog'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$d["sekai-xxmiku-svg-1-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$d["sekai-xxmiku-svg-2-".concat(size)]
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$d["sekai-xxmiku-svg-3-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$d["sekai-xxmiku-svg-4-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement(XxMikuSvg, {
    className: styles$d["sekai-xxmiku-svg-5-".concat(size)],
    type: 'type2'
  }), /*#__PURE__*/React.createElement("div", {
    ...
    id: "xo-miku-dialog-buttons",
    className: styles$d['sekai-xxmiku-button']
  }, buttonsProps))))), portalContainer);
};
...
var Drawer = function Drawer(_ref) {
  ...
  var posAbsoluteStyle = _objectSpread$d({}, containerComponent && {
    position: 'absolute'
  });
  return /*#__PURE__*/reactDom.createPortal(/*#__PURE__*/React.createElement("div", {
    className: clsx(globalStyles["sekai-overlay-".concat(modeTheme)], styles$c['sekai-drawer'], styles$c[displayDrawer]),
    style: posAbsoluteStyle,
    "aria-hidden": "true",
    onClick: onClose
  }, /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$c["sekai-drawer-contents-".concat(pos)], styles$c[displayDrawer], rest.className),
...
var DropdownContent = function DropdownContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ref: wrapDropdownRef,
    className: clsx(styles$b["sekai-dropdown-".concat(modeTheme)], rest.className),
    ...
    style: _objectSpread$c(_objectSpread$c({}, optionStyle), dropdownPosStyle),
    sekai: sekai,
    themeMode: themeMode,
    options: options,
    onSelect: onSelect
...
var DropdownTriggerButton = /*#__PURE__*/React.forwardRef(function (_ref4, ref) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ref: ref,
    type: "button",
    className: styles$b["sekai-dropdown-trigger-".concat(modeTheme)],
    onClick: handleClick,
    style: optionStyle
  }, /*#__PURE__*/React.createElement("span", {
    className: clsx(_defineProperty({}, styles$b['sekai-placeholder'], isDispPlaceholder))
  }, displayText), /*#__PURE__*/React.createElement(ChevronSvg, {
    className: clsx(styles$b['sekai-dropdown-icon'], _defineProperty(_defineProperty({}, styles$b['sekai-dropdown-icon-open'], openOptions), styles$b["sekai-dropdown-icon-close"], !openOptions)),
    sekai: sekai,
    themeMode: themeMode,
    vector: "down"
  }));
...
var DropdownOptions = function DropdownOptions(_ref6) {
  ...
  return isRendered ? /*#__PURE__*/React.createElement("ul", {
    className: clsx(styles$b['sekai-dropdown-options-list'], _defineProperty(_defineProperty({}, styles$b['sekai-dropdown-options-open'], isVisible), styles$b['sekai-dropdown-options-close'], !isVisible), globalStyles["sekai-color-".concat(modeTheme)]),
    style: _objectSpread$c(_objectSpread$c({}, optionStyle), style)
  }, options.map(function (option) {
    return /*#__PURE__*/React.createElement("li", {
      key: option.value,
      className: clsx(styles$b['sekai-dropdown-option-item'])
    }, /*#__PURE__*/React.createElement("button", {
...
var _excluded$a = ["sekaiKeys", "themeMode", "text", "duration"];
...
var DoReMeetEffect = function DoReMeetEffect(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    ...
    className: clsx(styles$a["sekai-doremeet-effect-".concat(modeTheme)], rest.className),
...
var styles$9 = {"into-the-sekai":"IntoTheSekai-module_into-the-sekai__GYjaM"};
styleInject(css_248z$9);

var _excluded$9 = ["execEvent", "containerComponent"];
  ...
  React.useEffect(function () {
    ...
    var _render = function render() {
      ...
      sekaiPieceRef.current = sekaiPieceRef.current.map(function (tri) {
        ...
        return _objectSpread$a(_objectSpread$a({}, tri), {}, {
          points: newPoints,
...
var TextLink = function TextLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", _extends({}, rest, {
    className: clsx(styles$8["sekai-text-link-".concat(modeTheme)], disabled && styles$8['sekai-disabled'], rest.className),
...
var List = function List(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ListContext.Provider, {
    ...
    className: clsx(globalStyles["sekai-color-".concat(modeTheme)], styles$7['sekai-list'], rest.className),
...
var ListItemButton = function ListItemButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    id: id,
    className: clsx(styles$7['sekai-list-item-button'], className),
    style: _objectSpread$7(_objectSpread$7({}, optionStyle), style)
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    ref: listItemButtonRef,
    className: styles$7["sekai-list-button-".concat(modeTheme)],
    disabled: disabled,
...
var getImgComponent$1 = function getImgComponent(icon) {
  ...
  if (typeof icon === 'string') {
    return /*#__PURE__*/React.createElement("img", {
      className: styles$7['sekai-list-icon'],
      src: icon,
      alt: ""
    });
  } else {
...
var createRippleEffect = function createRippleEffect(x, y, size) {
  ...
  ripple.className = styles$7["".concat(rippleEffectClassName)];
  return ripple;
};
...
var _excluded$6 = ["sekai", "themeMode", "children", "as", "icon"];
...
var ListItemText = function ListItemText(_ref) {
  ...
  return /*#__PURE__*/React.createElement("li", _extends({}, rest, {
    className: clsx(styles$7['sekai-list-item-text'], globalStyles["sekai-color-".concat(modeTheme)], rest.className),
...
var css_248z$6 = ".StickyNote-module_sekai-sticky-note__rheDG,\n.StickyNote-module_sekai-sticky-note__rheDG > button {\n  padding-left: 0;\n  padding-right: 0;\n}\n\n.StickyNote-module_sekai-sticky-note-parts__7ixUr {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  height: 100%;\n  background-color: var(--sekai-color-bg);\n  padding-right: 8px;\n}\n.StickyNote-module_sekai-sticky-note-parts__7ixUr .StickyNote-module_sekai-sticky-note-design__Aae2S {\n  width: 15px;\n  height: 100%;\n  background-color: var(--sekai-color);\n  margin-right: 8px;\n}";
var styles$6 = {"sekai-sticky-note":"StickyNote-module_sekai-sticky-note__rheDG","sekai-sticky-note-parts":"StickyNote-module_sekai-sticky-note-parts__7ixUr","sekai-sticky-note-design":"StickyNote-module_sekai-sticky-note-design__Aae2S"};
styleInject(css_248z$6);

var _excluded$5 = ["sekai", "children", "as"];
var StickyNote = function StickyNote(_ref) {
  ...
  return 'button' === as ? /*#__PURE__*/React.createElement(ListItemButton, _extends({}, rest, {
    className: clsx(styles$6['sekai-sticky-note'], rest.className),
    sekai: sekai,
    themeMode: LIGHT_MODE
...
var Loading = function Loading(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    role: "status",
    "aria-live": "polite",
    className: clsx(styles$5['sekai-loading'], className),
    style: _objectSpread$5(_objectSpread$5({}, optionStyle), style)
  }, Array.from({
    length: CIRCLE_COUNT
  }, function (_, index) {
    return /*#__PURE__*/React.createElement("div", {
      key: "circle-".concat(index),
      className: clsx(styles$5['sekai-loading-circle'], styles$5["sekai-circle-animation-".concat(index)])
    });
  }));
};
...
var Pagination = function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles$4["sekai-pagination-".concat(size)], rest.className),
    ...
    if (item === PaginationConstants.Ellipsis) {
      return /*#__PURE__*/React.createElement("span", {
        key: index,
        className: styles$4['sekai-pagination-ellipsis']
      }, '...');
    }
    return /*#__PURE__*/React.createElement("button", {
      key: index,
      className: clsx(styles$4["sekai-pagination-button-".concat(size)], styles$4["sekai-color-".concat(modeTheme)], _defineProperty({}, styles$4["sekai-pagination-selected"], item === currentPage)),
      onClick: function onClick() {
...
var CtrlButton = function CtrlButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    className: clsx(styles$4["sekai-pagination-button-".concat(size)]),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(ArrowSvg, _extends({}, rest, {
    vector: vector,
    className: styles$4['sekai-pagination-arrow']
  })));
};
