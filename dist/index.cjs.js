...
var useThemeMode = function useThemeMode2() {
  var _useState = React.useState(null), _useState2 = _slicedToArray(_useState, 2), isDarkMode = _useState2[0], setDarkMode = _useState2[1];
...
var CreationSekaiContext = /* @__PURE__ */ React.createContext(null);
var CreationSekaiProvider = function CreationSekaiProvider2(_ref) {
  var children = _ref.children, sekaiTheme = _ref.sekaiTheme;
  var _useState = React.useState(sekaiTheme), _useState2 = _slicedToArray(_useState, 2), currentSekaiTheme = _useState2[0], setCurrentSekaiTheme = _useState2[1];
...
exports.CreationSekaiContext = CreationSekaiContext;
exports.CreationSekaiProvider = CreationSekaiProvider;
