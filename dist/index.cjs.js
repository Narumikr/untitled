...
var YourSekaiProvider = function YourSekaiProvider(_ref) {
  ...
  var onSwitchSekaiColor = function onSwitchSekaiColor(sekai) {
    setCurrentSekaiTheme(function (pre) {
      return _objectSpread$2(
        ...
        {},
        {
          palette: _objectSpread$2(
            _objectSpread$2({}, pre.palette),
            {},
            {
              sekai: sekai
            }
  ...
  var globalStyle = React.useMemo(
    function () {
      var _sekaiTheme$typograph, _sekaiTheme$palette, _sekaiTheme$palette2
      return '\n    * {\n      font-family: '
        .concat(
          (_sekaiTheme$typograph = sekaiTheme.typography) === null ||
            _sekaiTheme$typograph === void 0
            ? void 0
            : _sekaiTheme$typograph.fontFamily,
          ';\n    }\n    body {\n      color: '
        )
        .concat(
          ((_sekaiTheme$palette = sekaiTheme.palette) === null || _sekaiTheme$palette === void 0
            ? void 0
            : _sekaiTheme$palette.mode) === DARK_MODE
            ? '#e0e0e0'
            : '#212121',
          ';\n      background: '
        )
        .concat(
          ((_sekaiTheme$palette2 = sekaiTheme.palette) === null ||
          _sekaiTheme$palette2 === void 0
            ? void 0
            : _sekaiTheme$palette2.mode) === DARK_MODE
            ? '#121212'
            : '#ffffff',
          ';\n    }\n  '
        )
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement('style', null, globalStyle),
    children
  )
}
    ...
    _extends(
      {
        type: 'button',
        className: [
          styles$1['sekai-basic-button-'.concat(modeTheme)],
          globalStyles['sekai-color-'.concat(modeTheme)],
          className
        ].join(' '),
        style: optionStyle,
        disabled: disabled
...
var styles = {
  'sekai-dialog-visible': 'Dialog-module_sekai-dialog-visible__MhxKQ',
  'sekai-dialog-hidden': 'Dialog-module_sekai-dialog-hidden__aznHA',
  'sekai-container': 'Dialog-module_sekai-container__ksO7t',
  'sekai-container-wide': 'Dialog-module_sekai-container-wide__NphhS',
  'sekai-container-medium': 'Dialog-module_sekai-container-medium__XUhgC',
  'sekai-container-narrow': 'Dialog-module_sekai-container-narrow__RgWNL',
  'sekai-content-wrap': 'Dialog-module_sekai-content-wrap__mWRrt',
  'sekai-title-header': 'Dialog-module_sekai-title-header__ATn1B',
  'sekai-title-header-wide': 'Dialog-module_sekai-title-header-wide__5Skds',
  'sekai-title-header-medium': 'Dialog-module_sekai-title-header-medium__61bst',
  'sekai-title-header-narrow': 'Dialog-module_sekai-title-header-narrow__uQfFd',
  'sekai-close-icon': 'Dialog-module_sekai-close-icon__CVbZJ',
  'sekai-buttons-area': 'Dialog-module_sekai-buttons-area__9vRBF',
  'sekai-normal-button-color': 'Dialog-module_sekai-normal-button-color__mq3H7',
  'sekai-light': 'Dialog-module_sekai-light__TlNmy',
  'sekai-dialog-normal-button-2-1': 'Dialog-module_sekai-dialog-normal-button-2-1__FBzF9',
  'sekai-dialog-normal-button-2-0': 'Dialog-module_sekai-dialog-normal-button-2-0__iZkb-',
  'sekai-dialog-normal-button-1-0': 'Dialog-module_sekai-dialog-normal-button-1-0__Ui4jg',
  'sekai-dark': 'Dialog-module_sekai-dark__M58Kq',
  'sekai-strong-button-color': 'Dialog-module_sekai-strong-button-color__gzYAg',
  'sekai-dialog-strong-button-2-1': 'Dialog-module_sekai-dialog-strong-button-2-1__WxTyF',
  'sekai-dialog-strong-button-2-0': 'Dialog-module_sekai-dialog-strong-button-2-0__z7H34',
  'sekai-dialog-strong-button-1-0': 'Dialog-module_sekai-dialog-strong-button-1-0__gM-wb'
}
        ...
        /*#__PURE__*/ React.createElement(
          'div',
          {
            ...
            'className': [
              ...
              styles['sekai-container-'.concat(size)],
              styles['sekai-'.concat(modeTheme)]
            ].join(' '),
            'style': optionStyle,
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(DialogTitleHeader, headerProps),
            children
          ),
          dialogButtons || /*#__PURE__*/ React.createElement(DialogButtons, buttonsProps)
        )
      )
    ),
    portalContainer
...
var DialogButtons = function DialogButtons(_ref3) {
  ...
  return /*#__PURE__*/ React.createElement(
    'div',
    {
      className: [styles['sekai-buttons-area'], className].join(' ')
    },
      ...
      return /*#__PURE__*/ React.createElement(
        'button',
        {
          ...
          'className': [
            ...
            styles$1[
              'sekai-dialog-'
                .concat(el.type || 'normal', '-button-')
                .concat(buttonLength, '-')
                .concat(index)
            ],
            styles$1['sekai-'.concat(modeTheme)],
            el.buttonStyle || ''
          ].join(' '),
          'style': optionStyle
        },
...
var createSekai = function createSekai(option) {
  ...
  var sekaiTheme = {
    ...
    typography: {
      fontFamily:
        (typography === null || typography === void 0 ? void 0 : typography.fontFamily) ||
