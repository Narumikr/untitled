...
declare const BasicButton: ({
  ...
  disabled,
  ...buttonProps
}: BasicButtonProps) => React.JSX.Element
...
declare const StrongButton: ({
  ...
  disabled,
  ...buttonProps
}: StrongButtonProps) => React.JSX.Element
...
declare const DialogTitleHeader: ({
  className,
  sekai,
  themeMode,
  size,
  ...
  title,
  showCloseIcon
}: DialogTitleHeaderProps) => React.JSX.Element | null
type DialogButtonsProps = Pick<DialogProps, 'sekai' | 'themeMode' | 'buttons'> & {
  className?: string
}
declare const DialogButtons: ({
  className,
  sekai,
  themeMode,
  buttons
}: DialogButtonsProps) => React.JSX.Element | null
...
declare const XxMikuDialog: ({
  ...
  title,
  buttons
}: XxMikuDialogProps) => React.ReactPortal
...
declare const YourSekaiProvider: ({
  children,
  sekaiTheme
}: YourSekaiProviderProps) => React.JSX.Element
...
declare const OutlineText: ({
  className,
  sekai,
  themeMode,
  text
}: OutlineTextProps) => React.JSX.Element
...
declare const fireOnEnterKey: (
  eventHandler: (e: KeyboardEvent) => void
) => (e: KeyboardEvent) => void
declare const fireOnEscapeKey: (
  eventHandler: (e: KeyboardEvent) => void
) => (e: KeyboardEvent) => void
